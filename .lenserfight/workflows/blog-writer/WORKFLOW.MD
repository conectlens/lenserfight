...
outputs:
  kind: text
rays: [blog, content, creator, workflow, template]
seed_uuid: 48000000-0002-0002-0001-000000000001
---

# Blog Writer Workflow

A 4-node workflow that converts a topic and angle into a publishable blog outline with an accompanying hero-image prompt and a validation pass.
