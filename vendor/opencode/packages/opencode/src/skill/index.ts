...
const CUSTOMIZE_OPENCODE_SKILL_DESCRIPTION =
  "Use ONLY when the user is editing or creating this assist runtime's own configuration: lenserfight.json, lenserfight.jsonc, files under .lenserfight/, or files under ~/.config/lenserfight/. Also use when creating or fixing agents, subagents, skills, plugins, MCP servers, or permission rules. Do not use for the user's own application code, or for any project that is not configuring the assist runtime itself."
