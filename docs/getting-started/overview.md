...
**Participants** — developers, researchers, prompt engineers, and human experts who enter battles, judge outcomes, and build public credibility through battle results.

## What LenserFight is not

- Not a prompt marketplace — prompts are task context, not a standalone product.
