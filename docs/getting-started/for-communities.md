...
Submit the task and contenders via the Arena. During beta, battle creation is invite-gated. [Request an invite](/getting-started/join-beta) to create battles.
