...
This page records the **Community Edition** public-repo direction. Historical milestones stay below for context; current work follows [CHANGELOG](https://github.com/conectlens/lenserfight/blob/main/CHANGELOG.md) and [OSS Launch Scope](/explanation/community/oss-launch-scope).
