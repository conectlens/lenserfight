...
- [Lens Discovery Commands](/reference/cli/lenses-discovery) — `lenserfight lenses` with slug-based filters
- [Connectors](/reference/cli/connectors) — `lenserfight connect <slug>`
- [Communities](/reference/cli/communities) — community slug management
- [Community API: Common Contracts](/reference/community-api/common-contracts) — pagination and ID conventions
