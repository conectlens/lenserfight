...
- Library: [`libs/adapters/connector`](https://github.com/conectlens/lenserfight-web/tree/main/libs/adapters/connector)
- Contract types: [`libs/api/contracts`](https://github.com/conectlens/lenserfight-web/tree/main/libs/api/contracts)
- Reference example: [`examples/connectors/chainabit-example`](https://github.com/conectlens/lenserfight-web/tree/main/examples/connectors/chainabit-example)
