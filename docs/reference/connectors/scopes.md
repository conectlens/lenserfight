...
|---|---|
| [`libs/adapters/connector/src/lib/scopes.ts`](https://github.com/connectlens/lenserfight-web/blob/main/libs/adapters/connector/src/lib/scopes.ts) | TypeScript constant `CONNECTOR_SCOPES` + `ConnectorScope` literal type |
