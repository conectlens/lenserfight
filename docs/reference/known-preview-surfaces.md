...
- [Kill Switch](/how-to/kill-switch) — per-agent and platform-level kill switch guide
- [Release Checklist](/how-to/contributors/release-checklist) — checklist for verifying flag state before shipping
