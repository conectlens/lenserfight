...
- [SDK quickstart](/how-to/integrations/sdk-quickstart) — 10-step walkthrough
- [Connector SDK](/reference/connectors/index) — the separate `@lenserfight/adapter-connector` package for building inbound connectors
- [Anonymous browse RPC](/reference/api/fn-browse-battles) — server-side details of `fn_browse_battles`
