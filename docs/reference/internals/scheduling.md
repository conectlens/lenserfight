...
CRON scheduling requires a full Supabase instance and the `FEATURE_CRON_SCHEDULING=true` flag. It is **disabled by default** in self-hosted Community Edition installs. See [Known Preview Surfaces](/reference/known-preview-surfaces).
:::
