...
3. `apps/landing/src/locales/<dil>.json` ve `apps/landing/src/locales/<dil>/policies/` oluştur.
4. `docs/<dil>/index.md` oluştur, VitePress yapılandırmasına ekle (`apps/docs/.vitepress/config.ts`): `locales`, `hreflang`, `inLanguage`.
5. Doğrulama: `pnpm nx build web/landing/docs`, ardından her uygulamada elle test et.
