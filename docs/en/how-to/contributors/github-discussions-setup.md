...
6. Pin a welcome post in **Q&A** with links to: [Finding Work](/en/how-to/contributors/finding-work), [Contributing](/en/how-to/contributors/contributing), [Security](/en/how-to/contributors/security).
