...
- the **LenserFight** name and logos are **not** covered by the software license; see [Brand guidelines](/en/explanation/community/brand-guidelines) (repository `BRAND.md`)
