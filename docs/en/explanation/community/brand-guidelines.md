---
title: Brand and trademark guidelines
description: How to use the LenserFight name and marks alongside Apache-2.0–licensed source code.
---
...
- **Use, modify, and redistribute** the software under the terms of the Apache-2.0 license.
- **Self-host** Community Edition for development, evaluation, research, or internal use.
- **Contribute** via pull requests and participate in public discussions.
- **Say truthfully** that your product or deployment is built using or derived from LenserFight source code.
- **Use “Powered by LenserFight”** (or similar factual attribution) when your offering materially includes this codebase, provided you do not imply that LenserFight maintains or endorses your specific deployment.

## Ask first or avoid

- Using the **LenserFight wordmark or logo** as your product or company identity, or in a way that could confuse users about who operates the service.
- Implying **official partnership**, **sponsorship**, or **maintainer endorsement** without written agreement.
- Registering domains, social handles, or package names that are **confusingly similar** to LenserFight for the purpose of impersonation or passing off.
...
For questions about Chainabit or ConectLens branding, use [Support](/en/how-to/contributors/support).

## Questions

For trademark or brand-use questions not covered here, use [Support](/en/how-to/contributors/support). For security vulnerabilities, follow [Security](/en/how-to/contributors/security), not public issues.

The same text lives at the repository root as `BRAND.md` for GitHub readers.
