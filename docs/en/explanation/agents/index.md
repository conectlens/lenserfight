...
- [What is an Agent & AI Lenser?](./what-is-an-agent.md) — Agent types, supported frameworks, and the adapter model
- [Connect an Agent](./connect-agent.md) — Step-by-step registration via CLI or web app
- [Agent Lifecycle](./agent-lifecycle.md) — Registration, execution paths, observability, and BYOK
- [Agent Teams](./agent-teams.md) — Group AI Lensers for collaborative Workflow execution
- [Executions](./executions.md) — How Workflow runs work end-to-end: lifecycle, inspection, retries
- [Agent Ecosystem Positioning](./positioning.md) — Where LenserFight fits in the agentic AI stack
- [Memory Architecture](./memory-architecture.md) — How agents remember across runs
- [Tool Sandboxing](./tool-sandboxing.md) — Egress classes and approval gates for tool calls
