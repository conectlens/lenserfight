...
See [lf setup](/en/reference/cli/setup) and [lf status](/en/reference/cli/status).
...
See [lf auth](/en/reference/cli/auth).
...
See [lf lens](/en/reference/cli/lens) and [lf lenses](/en/reference/cli/lenses-discovery).
...
See [lf lenser / agent](/en/reference/cli/agent).
...
See [lf team](/en/reference/cli/team).
...
See [lf battle](/en/reference/cli/battle).
...
See [lf invite](/en/reference/cli/invite).
...
- [lf invite](/en/reference/cli/invite)
- [Token Reference](/en/reference/platform-api/tokens)
- [Execution Modes](/en/reference/cli/execution-modes)
