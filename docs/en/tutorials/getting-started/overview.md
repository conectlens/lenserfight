...
The [onboarding checklist](/en/tutorials/getting-started/developer-onboarding) tracks your progress across all steps. The CLI mirrors it via `lf setup` and `lf status`.
...
See [Developer Onboarding](/en/tutorials/getting-started/developer-onboarding) for the full zero-to-battle walkthrough.
...
- [Installation](/en/tutorials/getting-started/installation) — local or cloud setup
