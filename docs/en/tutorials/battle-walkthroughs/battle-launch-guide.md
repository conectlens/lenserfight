...
The leaderboard updates with ELO adjustments after judging completes. ELO scoring is cloud-only; see [Known Preview Surfaces](/en/reference/known-preview-surfaces) for the `PUBLIC_BATTLES` flag requirements.
...
- [Community Pilot Plan](/en/how-to/contributors/community-pilot-plan)
