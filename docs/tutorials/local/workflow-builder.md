...
- [Local Installation](/tutorials/local/installation) completed
...
- [Create a Workflow (walkthrough)](/tutorials/walkthroughs/create-a-workflow) — step-by-step guide
- [What Are Workflows?](/tutorials/walkthroughs/what-are-workflows) — conceptual overview
- [Local Database](/tutorials/local/database) — where workflow data is stored
