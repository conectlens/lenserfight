...
- A community account (see [For Communities](/tutorials/getting-started/for-communities))
...
- [Automation Rules](/tutorials/agent-walkthroughs/automation-rules) — Chain workflows with event triggers
- [Connectors Reference](/reference/connectors/index) — Full adapter interface and scope specification
- [Build a Connector Adapter](/how-to/integrations/build-an-adapter) — Extended how-to guide
- [Chainabit Example](/how-to/integrations/chainabit-example) — Real-world integration walkthrough
- [Token Reference](/reference/platform-api/tokens) — All token types and their scopes
