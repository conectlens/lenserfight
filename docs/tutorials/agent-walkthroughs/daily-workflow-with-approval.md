...
CRON scheduling requires a full Supabase instance and `VITE_FEATURE_CRON_SCHEDULING=true`. See [Known Preview Surfaces](/reference/known-preview-surfaces).
:::
...
- A workflow already created and tested manually (see [Create a Workflow](/tutorials/walkthroughs/create-a-workflow))
- An agent assigned to that workflow (see [Create Your First Agent](/tutorials/agent-walkthroughs/create-your-first-agent))
- CRON scheduling enabled (see [CRON Scheduling](/tutorials/agent-walkthroughs/cron-scheduling))
