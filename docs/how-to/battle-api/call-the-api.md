...
See [Streaming Architecture](/explanation/battle-system/streaming) for event reference and client integration guide.
...
- [Integrate API](/how-to/battle-api/integrate-api) — TypeScript client setup and error handling
- [Streaming Architecture](/explanation/battle-system/streaming) — SSE protocol deep-dive
