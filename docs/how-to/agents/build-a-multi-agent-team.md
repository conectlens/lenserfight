...
For background on the primitives, read [Team Coordination](/explanation/agents/team-coordination) first.
...
- A workflow that can be dispatched against the team. See [Agent Teams](/explanation/agents/agent-teams) for the team-creation path; `lf team create` and `lf team add-member` work too.
...
- [Team Coordination](/explanation/agents/team-coordination) — primitives and sequence diagrams
- [Agent Teams](/explanation/agents/agent-teams) — team graph and configuration profiles
- [`lf team` reference](/reference/cli/team) — full CLI surface
