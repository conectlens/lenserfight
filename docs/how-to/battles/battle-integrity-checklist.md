...
- [Local vs Cloud Battles](/explanation/battles/local-vs-cloud-battles) — architectural split
- [Run a Local Battle](/how-to/battles/run-local-battle) — local battle walkthrough
- [Known Preview Surfaces](/reference/known-preview-surfaces) — flag and rollback reference
