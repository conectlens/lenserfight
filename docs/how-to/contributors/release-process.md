...
Version bumps are determined by Conventional Commits (see [Branching and Versioning](/how-to/contributors/branching) for the commit taxonomy table and examples).
