...
Read [Lenser DNA](/explanation/lensers/lenser-dna) to understand the base blueprint, visual constraints, and naming rules. Your proposal must comply with them or it will be rejected at the DNA validation step.
...
- [Lenser DNA](/explanation/lensers/lenser-dna) — base blueprint and visual constraints
...
- [Contributing Guide](/how-to/contributors/contributing) — general contribution process
