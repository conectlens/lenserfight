...
1. **Open an exploratory issue.** Use the [adapter idea](https://github.com/connectlens/lenserfight-web/issues/new?template=adapter_idea.yml) template. Capture the target service, the auth model, the scopes you think you'll need, and whether you intend to implement it yourself.
