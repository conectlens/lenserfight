...
See [API Overview](/reference/api-overview) for the full error code reference.
...
See [Streaming Architecture](/explanations/streaming) for a deep-dive on the SSE protocol and credit reservation lifecycle.
...
- [Call the API](/how-to/call-the-api) — Raw curl examples for every endpoint
- [API Overview](/reference/api-overview) — Full endpoint and error code reference
- [Streaming Architecture](/explanations/streaming) — SSE streaming internals
