...
| File | Purpose |
|---|---|
| [`src/adapter.ts`](https://github.com/conectlens/lenserfight-web/blob/main/examples/connectors/chainabit-example/src/adapter.ts) | Wraps `HttpConnectorAdapter` to produce a `ConnectorAdapterV1` |
| [`src/index.ts`](https://github.com/conectlens/lenserfight-web/blob/main/examples/connectors/chainabit-example/src/index.ts) | Runnable demo flow |
| [`.env.example`](https://github.com/conectlens/lenserfight-web/blob/main/examples/connectors/chainabit-example/.env.example) | Required env vars (token + endpoint) |
