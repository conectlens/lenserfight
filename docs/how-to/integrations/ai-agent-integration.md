...
Store the token as `LENSERFIGHT_API_KEY` in your environment or secrets manager. See the full [Token Reference](/reference/platform-api/tokens) for scopes and rotation.
...
- [Token Reference](/reference/platform-api/tokens) — service tokens, developer tokens, scopes, rotation
- [API Overview](/reference/platform-api/api-overview) — execution API, error codes, rate limits
- [Lenses API Reference](/reference/community-api/lenses) — lens schema, versioning, publishing
- [Workflows API Reference](/reference/community-api/workflows) — workflow configs and run results
- [Providers and Execution](/reference/community-api/providers-and-execution) — execution models (BYOK, cloud, local)
