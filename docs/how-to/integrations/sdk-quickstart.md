...
- [SDK reference](/reference/sdk) — full method-by-method docs
- [`fn_browse_battles` server reference](/reference/api/fn-browse-battles) — what the server actually does
