...
- [Automation Triggers](/explanation/automation/triggers) — All trigger types: manual, scheduled, event, API
- [Automation Workspace Overview](/explanation/automation/index) — Workspace structure and product layers
- [Workflow Concepts](/explanation/workflows/workflow-concepts) — DAG model, nodes, edges, and runs
- [Workflow Types](/explanation/workflows/workflow-types) — Sequential, parallel, conditional, and scheduled patterns
