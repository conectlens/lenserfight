...
Phase X introduced five primitives that turn a team graph (see [Agent Teams](/explanation/agents/agent-teams)) into a runtime coordination surface:
...
- [Agent Teams](/explanation/agents/agent-teams) — team graph, edges, profiles
- [Build a Multi-Agent Team](/how-to/agents/build-a-multi-agent-team) — end-to-end walkthrough
- [`lf team` reference](/reference/cli/team) — CLI surface
