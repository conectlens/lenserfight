...
- [BYOK execution](/how-to/battles/byok-execution) — how to use `--stream-to-web` in practice
- [Stream a cloud battle with BYOK](/tutorials/battle-walkthroughs/byok-cloud-battle) — end-to-end tutorial
- [useBattleCliStream hook](/reference/battles/index) — React hook API reference
