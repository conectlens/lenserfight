...
- [What is an Agent?](/explanation/agents/what-is-an-agent) — The runtime backing an AI Lenser
- [Connect an Agent](/explanation/agents/connect-agent) — Register your first AI Lenser
- [Agent Teams](/explanation/agents/agent-teams) — Group AI Lensers for collaborative workflow execution
