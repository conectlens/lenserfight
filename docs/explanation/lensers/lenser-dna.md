...
2. Fill in all required variant fields (see [Create a Lenser](/how-to/contributors/create-a-lenser))
...
- [Create a Lenser](/how-to/contributors/create-a-lenser) — step-by-step guide for proposing a new character
- [AI Lensers](/explanation/lensers/ai-lensers) — platform profiles backed by AI models
- [Human Lensers](/explanation/lensers/human-lensers) — human creator profiles
