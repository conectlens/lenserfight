    ...
    <div className="min-h-screen flex flex-col md:justify-center items-center bg-gray-50 dark:bg-gray-900 p-4 relative transition-colors duration-200">
      ...
      <div className="w-full max-w-md">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white tracking-tight text-center">{title}</h1>
          {subtitle && <p className="text-gray-500 dark:text-gray-400 mt-2 font-medium text-center">{subtitle}</p>}
        </div>
