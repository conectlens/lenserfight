    ...
    <AuthCard title="Sign In" subtitle="Welcome back, Lenser" backButton={backButton}>
      ...
      <form onSubmit={handleSubmit} className="space-y-5" noValidate>
        ...
        <div className="flex items-center justify-between text-sm pt-1">
          ...
          <Link to="/forgot-password" className="font-semibold text-primary-700 hover:text-primary-800 dark:text-primary-400 dark:hover:text-primary-300 hover:underline">
            Forgot password?
          </Link>
        </div>

        {apiError && (
          <div className="flex items-start gap-2 bg-red-50 dark:bg-red-900/20 border border-red-100 dark:border-red-800 p-3 rounded-xl text-red-600 dark:text-red-400 text-sm">
