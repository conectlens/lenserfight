    ...
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden transition-colors">
      <div className="p-8 border-b border-gray-100 dark:border-gray-700">
        ...
        <div className="flex items-center gap-4 mb-6">
            ...
            <div>
                <h3 className="text-base font-semibold text-gray-900 dark:text-white">{prompt.author.displayName}</h3>
        ...
        {prompt.description && (
            <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed mb-6">{prompt.description}</p>
        )}
      ...
      <div className="bg-gray-50 dark:bg-gray-900 p-8 transition-colors">
        <div className="flex justify-between items-center mb-3">
            <h3 className="text-sm font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Prompt Template</h3>
