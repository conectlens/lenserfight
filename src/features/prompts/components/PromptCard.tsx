    ...
    >
      ...
      <div className="flex justify-between items-start mb-4 pt-2">
          ...
          {prompt.visibility === 'private' && (
              <div className="text-gray-300 dark:text-gray-600 ml-2 mt-1 flex-shrink-0" title="Private Prompt">
                  <Lock size={14} />
              </div>
          )}
      </div>
      ...
      <div className="flex flex-wrap gap-2 mb-6">
        ...
        {prompt.tags.length > 3 && (
            <span className="text-[10px] text-gray-400 dark:text-gray-600 self-center px-1 font-medium">+{prompt.tags.length - 3}</span>
        )}
      </div>
      ...
      <div className="flex items-center justify-between pt-4 border-t border-gray-50 dark:border-gray-700 mt-auto">
          ...
          >
            <Avatar src={prompt.author.avatarUrl} alt={prompt.author.displayName} size="sm" className="!w-6 !h-6 ring-2 ring-white dark:ring-gray-800" />
          ...
          <div className="flex items-center gap-1.5 text-gray-400 dark:text-gray-500 group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors" title={`${prompt.usageCount} uses`}>
             <Copy size={14} />
