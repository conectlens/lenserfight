      ...
      <div className="relative z-10 flex flex-col md:flex-row items-start gap-6">
        ...
        <div className="flex-1">
           <div className="flex items-center gap-3 mb-2">
              <h1 className="text-3xl font-extrabold text-gray-900 dark:text-white capitalize tracking-tight">{tag.name}</h1>
              <span className="px-2.5 py-0.5 rounded-full bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 text-xs font-bold uppercase tracking-wider">Topic</span>
           </div>
           ...
           <div className="flex flex-wrap items-center gap-6 text-sm font-medium text-gray-500 dark:text-gray-400">
              <div className="flex items-center gap-1.5" title="Total global uses across all types">
                  <span className="text-gray-900 dark:text-gray-200 font-bold">{formatCount(tag.count)}</span>
