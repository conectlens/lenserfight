      ...
      <div className="flex-1 min-w-0 pb-6">
        <div className="bg-gray-50/50 rounded-xl p-4 border border-gray-100">
            <div className="flex items-center gap-2 mb-2">
              <span className="font-semibold text-gray-900 text-sm">{reply.author.displayName}</span>
            ...
            {!reply.isDeleted && (
                <div className="flex items-center gap-4">
                    <button 
                        ...
                        className="flex items-center gap-1.5 text-gray-500 hover:text-primary-600 transition-colors text-xs font-medium"
                    >
