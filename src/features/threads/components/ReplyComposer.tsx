...
export const ReplyComposer: React.FC<ReplyComposerProps> = ({ onSubmit, placeholder, autoFocus, onCancel }) => {
    ...
    <div className="flex gap-4 items-start">
      ...
      <div className="flex-1">
        ...
        <div className="flex justify-end gap-2 mt-2">
           {onCancel && (
             <Button variant="ghost" onClick={onCancel} className="w-auto px-4 py-1.5 h-auto text-sm">Cancel</Button>
           )}
           <Button 
