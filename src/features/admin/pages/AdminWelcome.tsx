...
export const AdminWelcome: React.FC = () => {
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Welcome, Super Admin</h1>
        <p className="text-gray-500 dark:text-gray-400">Overview of the LenserFight ecosystem health.</p>
      </div>
