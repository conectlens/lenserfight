...
export const AdminAnalytics: React.FC = () => {
  ...
  const mapChartData = (series: { date: string, count: number }[]) => 
      series.map(s => ({ label: new Date(s.date).toLocaleDateString(undefined, { month: 'short', day: 'numeric' }), value: s.count }));
    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <Card className="p-6 md:p-8">
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">Traffic trends over the last 30 days</p>
          </div>
          <div className="h-64">
             <AreaChart 
