    ...
    <div className="space-y-8">
      ...
      <section>
        ...
        <div className="flex flex-wrap gap-4">
            ...
            <Button variant="secondary" className="w-auto">Secondary Button</Button>
            <Button variant="ghost" className="w-auto">Ghost Button</Button>
            <Button isLoading className="w-auto">Loading</Button>
            <Button disabled className="w-auto">Disabled</Button>
        </div>
      </section>
