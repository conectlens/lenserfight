...
import { LayoutDashboard, BarChart2, Users, Palette, MessageSquare, Clock, Mail, LogOut, ArrowLeft } from 'lucide-react';
  ...
  return (
    <div className="w-64 bg-gray-900 dark:bg-black text-white flex flex-col h-screen fixed left-0 top-0 overflow-y-auto z-50 border-r border-gray-800 dark:border-gray-800 transition-colors duration-200">
      <div className="p-6 border-b border-gray-800 flex items-center gap-3">
        <div className="w-8 h-8 bg-red-600 rounded-lg flex items-center justify-center font-bold text-white shadow-lg shadow-red-900/20">A</div>
      ...
      <div className="p-4 border-t border-gray-800 space-y-2">
        <Link to="/" className="flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium text-gray-400 hover:text-white hover:bg-gray-800 transition-colors">
