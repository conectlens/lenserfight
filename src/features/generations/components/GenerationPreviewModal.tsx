  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
        ...
        `}>
            ...
            {/* Media Content Area */}
            <div className={`
                w-full md:flex-1 flex items-center justify-center relative min-h-[300px] bg-gray-50 flex-shrink-0
            ...
            `}>
                ...
                {media.media_kind === 'text' && (
                    <div className="p-8 md:p-12 w-full h-auto md:h-full md:overflow-y-auto generations-scroll">
                        <div className="prose prose-lg max-w-none text-gray-800 whitespace-pre-wrap font-sans leading-loose">
            ...
            `}>
                ...
                <div className="space-y-6 flex-1 md:overflow-y-auto generations-scroll">
                    <div>
                        <span className="text-xs font-bold uppercase tracking-wider text-gray-400">Model</span>
                ...
                <div className="mt-6 pt-6 border-t border-gray-100 flex flex-col gap-3 flex-shrink-0">
