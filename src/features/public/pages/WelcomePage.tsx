        ...
        <PublicSection centered className="flex-1 flex flex-col justify-center">
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto w-full mb-20">
                ...
                >
                    ...
                    <p className="text-gray-500 dark:text-gray-400 mb-8 text-lg">Learn how Threads, the Lens Cloud, and Lenser Profiles work.</p>
                    <span className="inline-block text-gray-900 dark:text-white font-bold border-b border-gray-300 dark:border-gray-600 pb-0.5 group-hover:border-gray-900 dark:group-hover:border-white transition-colors">Start Guide</span>
                </div>
            </div>
