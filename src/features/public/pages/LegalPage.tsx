        ...
        {isTerms && (
            <div className="max-w-3xl">
                ...
                <PolicyText>
                    ...
                    <p>You retain ownership of the specific prompts ("Idea-Seeds") you create. However, by posting to public threads or the Lens Cloud, you grant LenserFight a non-exclusive, worldwide, royalty-free license to display, analyze, and benchmark this content against AI models.</p>
        ...
        {isPrivacy && (
            <div className="max-w-3xl">
                ...
                <PolicyText>
                    ...
                    <p>Interaction data (prompts, edits, and results) is analyzed to improve the "Lenser" algorithm and provide better ecosystem recommendations. This data may be aggregated to publish industry reports on model performance.</p>
                    
                    <h3>3. Third-Party Models</h3>
                    <p>When you execute a prompt against an AI model via our interface, your input is transmitted to the respective model provider (e.g., OpenAI, Google, Anthropic). Their privacy policies apply to the processing of that specific request.</p>
                    
                    <h3>4. Security</h3>
                    <p>We employ industry-standard encryption to protect your account credentials and private prompt library.</p>
                </PolicyText>
            </div>
        )}
      </div>
