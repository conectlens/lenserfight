      ...
      <div className="max-w-lg mx-auto mt-8">
        {sent ? (
            <div className="bg-green-50 dark:bg-green-900/20 border border-green-100 dark:border-green-800 rounded-2xl p-10 text-center animate-in fade-in zoom-in">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-8">We've received your inquiry and will get back to you shortly.</p>
                <Button variant="ghost" onClick={() => setSent(false)} className="w-auto">Send another message</Button>
            </div>
        ) : (
            <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 p-8 md:p-10 rounded-2xl border border-gray-200 dark:border-gray-700 text-left space-y-6 shadow-sm">
                ...
                <div className="pt-2">
                    <label className="flex items-start gap-3 cursor-pointer group">
                        <div className="relative flex items-center mt-0.5">
                            ...
                            <Check className="w-3.5 h-3.5 text-white dark:text-gray-900 absolute left-[3px] top-[3px] opacity-0 peer-checked:opacity-100 transition-opacity pointer-events-none" strokeWidth={3.5} />
                        </div>
                        <span className="text-sm text-gray-500 dark:text-gray-400 leading-tight">
                            I agree to the processing of my personal data in accordance with the <a href="/legal/privacy" target="_blank" className="text-gray-900 dark:text-gray-200 hover:underline font-medium">Privacy Policy</a> (KVKK).
                        </span>
                    </label>
                </div>
                ...
                <Button type="submit" isLoading={loading} className="w-full h-12 text-base font-bold bg-gray-900 dark:bg-white text-white dark:text-gray-900 hover:bg-gray-800 dark:hover:bg-gray-200">
                    Send Message
                </Button>
            </form>
        )}
        ...
        <div className="mt-12 flex flex-col md:flex-row justify-center items-center gap-6 md:gap-12 text-sm font-medium text-gray-500 dark:text-gray-400">
            <a href="mailto:support@lenserfight.com" className="flex items-center gap-2 hover:text-gray-900 dark:hover:text-white transition-colors">
            ...
            <a href="/faq" className="flex items-center gap-2 hover:text-gray-900 dark:hover:text-white transition-colors cursor-not-allowed opacity-50" title="Coming Soon">
