      ...
      >
        ...
        >
          <div className="flex items-center gap-3">
             <div className={`p-2 rounded-lg transition-colors ${isExpanded ? 'bg-red-100 text-red-600 dark:bg-red-900/20 dark:text-red-400' : 'bg-gray-100 text-gray-500 dark:bg-gray-800 dark:text-gray-400'}`}>
                <ShieldAlert size={18} />
             </div>
             <div>
          ...
          <div className={`p-2 rounded-full transition-all duration-300 ${isExpanded ? 'rotate-180 bg-gray-200 dark:bg-gray-700 text-gray-900 dark:text-gray-100' : 'text-gray-400 group-hover:bg-gray-100 dark:group-hover:bg-gray-800'}`}>
             <ChevronDown size={16} />
          </div>
        </button>
            ...
            <div className="p-4 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg mb-6 text-sm">
               <div className="flex gap-3">
                  ...
                  <div className="space-y-2 text-gray-600 dark:text-gray-300">
                     <p className="font-semibold text-gray-900 dark:text-gray-100">Please read carefully</p>
                     <p>{description}</p>
                     <p>This action will initiate a deletion request. You will be logged out immediately and access will be restricted.</p>
                  </div>
               </div>
            </div>
