...
ALTER TYPE "xp"."contribution_context_enum" OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "audit"."log_event"("p_event_type" "text", "p_entity_schema" "text" DEFAULT NULL::"text", "p_entity_table" "text" DEFAULT NULL::"text", "p_entity_id" "uuid" DEFAULT NULL::"uuid", "p_actor_lenser_id" "uuid" DEFAULT NULL::"uuid", "p_actor_actor_id" "uuid" DEFAULT NULL::"uuid", "p_payload" "jsonb" DEFAULT '{}'::"jsonb", "p_severity" "text" DEFAULT 'info'::"text") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
...
ALTER FUNCTION "audit"."log_event"("p_event_type" "text", "p_entity_schema" "text", "p_entity_table" "text", "p_entity_id" "uuid", "p_actor_lenser_id" "uuid", "p_actor_actor_id" "uuid", "p_payload" "jsonb", "p_severity" "text") OWNER TO "postgres";


COMMENT ON FUNCTION "audit"."log_event"("p_event_type" "text", "p_entity_schema" "text", "p_entity_table" "text", "p_entity_id" "uuid", "p_actor_lenser_id" "uuid", "p_actor_actor_id" "uuid", "p_payload" "jsonb", "p_severity" "text") IS 'Append an audit event. SECURITY DEFINER — call from triggers or Edge Functions.';
...
COMMENT ON FUNCTION "battles"."fn_auto_finalize_battles"() IS 'Called by pg_cron every 5 minutes. Phase 1: voting→scoring for expired battles. Phase 2: scoring→closed via fn_battles_finalize. Returns count finalized. Errors per-battle are caught and logged to audit.events.';
...
CREATE OR REPLACE FUNCTION "lensers"."fn_sync_relationship_counts"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    SET "search_path" TO 'lensers', 'analytics'
    AS $$
DECLARE
...
CREATE OR REPLACE FUNCTION "lensers"."log_account_lifecycle_event"("p_profile_id" "uuid", "p_user_id" "uuid", "p_event_type" "text", "p_from_status" "lensers"."lenser_status", "p_to_status" "lensers"."lenser_status", "p_actor_source" "text", "p_metadata" "jsonb" DEFAULT '{}'::"jsonb") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
...
CREATE OR REPLACE FUNCTION "public"."fn_battles_clone"("p_battle_id" "uuid", "p_title" "text", "p_slug" "text") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'battles', 'lensers'
    AS $$
DECLARE
...
CREATE OR REPLACE FUNCTION "public"."fn_battles_close"("p_battle_id" "uuid") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'battles', 'lensers'
    AS $$
DECLARE
...
CREATE OR REPLACE FUNCTION "public"."fn_battles_delete"("p_battle_id" "uuid") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'battles', 'lensers'
    AS $$
DECLARE
...
CREATE OR REPLACE FUNCTION "public"."fn_battles_leaderboard"("p_battle_id" "uuid") RETURNS TABLE("rank" integer, "contender_id" "uuid", "display_name" "text", "score" numeric, "vote_count" integer)
    LANGUAGE "plpgsql" SECURITY DEFINER
...
CREATE OR REPLACE FUNCTION "public"."fn_battles_list_public"("p_limit" integer DEFAULT 20, "p_offset" integer DEFAULT 0) RETURNS TABLE("id" "uuid", "title" "text", "slug" "text", "status" "text", "contender_count" bigint, "vote_count_a" integer, "vote_count_b" integer, "vote_count_draw" integer, "creator_display_name" "text", "created_at" timestamp with time zone, "voting_opens_at" timestamp with time zone, "voting_closes_at" timestamp with time zone)
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'battles', 'lensers'
    AS $$
BEGIN
...
CREATE OR REPLACE FUNCTION "public"."fn_battles_retract"("p_battle_id" "uuid") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'battles', 'lensers'
    AS $$
DECLARE
...
CREATE OR REPLACE FUNCTION "public"."fn_battles_submit"("p_battle_id" "uuid", "p_content_text" "text" DEFAULT NULL::"text", "p_content_url" "text" DEFAULT NULL::"text", "p_content_media" "jsonb" DEFAULT NULL::"jsonb", "p_execution_run_id" "uuid" DEFAULT NULL::"uuid", "p_artifact_id" "uuid" DEFAULT NULL::"uuid", "p_source_type" "text" DEFAULT 'manual'::"text", "p_adapter_id" "uuid" DEFAULT NULL::"uuid", "p_model_id" "uuid" DEFAULT NULL::"uuid") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
...
CREATE OR REPLACE FUNCTION "public"."fn_battles_vote"("p_battle_id" "uuid", "p_vote" "battles"."vote_value_enum", "p_rationale" "text" DEFAULT NULL::"text", "p_contender_id" "uuid" DEFAULT NULL::"uuid") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'battles', 'lensers', 'actors'
    AS $$
DECLARE
...
CREATE OR REPLACE FUNCTION "public"."fn_lensers_list"("p_type" "text" DEFAULT NULL::"text", "p_limit" integer DEFAULT 20, "p_offset" integer DEFAULT 0) RETURNS TABLE("id" "uuid", "handle" "text", "display_name" "text", "avatar_url" "text", "bio" "text", "type" "lensers"."lenser_type", "ai_model_id" "uuid", "created_at" timestamp with time zone, "engagement" "jsonb")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'lensers', 'public'
    AS $$
BEGIN
...
CREATE OR REPLACE FUNCTION "xp"."auto_create_next_season"("p_app_id" "uuid", "p_duration_days" integer DEFAULT 90) RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
...
ALTER FUNCTION "xp"."auto_create_next_season"("p_app_id" "uuid", "p_duration_days" integer) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "xp"."grant_contribution_xp"("p_lenser_id" "uuid", "p_context" "xp"."contribution_context_enum", "p_contribution_type" "text", "p_external_ref" "text" DEFAULT NULL::"text", "p_title" "text" DEFAULT NULL::"text", "p_metadata" "jsonb" DEFAULT NULL::"jsonb") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'xp', 'lensers', 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "xp"."grant_contribution_xp"("p_lenser_id" "uuid", "p_context" "xp"."contribution_context_enum", "p_contribution_type" "text", "p_external_ref" "text", "p_title" "text", "p_metadata" "jsonb") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "actors"."actors" (
    ...
    CONSTRAINT "actors_agent_requires_ref" CHECK ((("actor_type" <> 'agent'::"text") OR (("ai_model_id" IS NOT NULL) OR ("agent_adapter_id" IS NOT NULL) OR ("agent_instance_id" IS NOT NULL)))),
    CONSTRAINT "actors_human_requires_profile" CHECK ((("actor_type" <> 'human'::"text") OR ("profile_id" IS NOT NULL))),
    CONSTRAINT "actors_status_check" CHECK (("status" = ANY (ARRAY['active'::"text", 'inactive'::"text", 'suspended'::"text"]))),
    CONSTRAINT "actors_type_check" CHECK (("actor_type" = ANY (ARRAY['human'::"text", 'agent'::"text", 'team'::"text", 'community'::"text", 'system'::"text"]))),
    CONSTRAINT "actors_visibility_check" CHECK (("visibility" = ANY (ARRAY['public'::"text", 'community'::"text", 'private'::"text"])))
);
...
COMMENT ON COLUMN "actors"."actors"."agent_instance_id" IS 'FK to agents.agent_instances when actor_type=agent and backed by a deployed instance. Allows actors to find their BYOK config and runtime profile.';



COMMENT ON CONSTRAINT "actors_agent_requires_ref" ON "actors"."actors" IS 'Agent actors must be backed by an ai_model, agent_adapter, or agent_instance.';
...
CREATE TABLE IF NOT EXISTS "actors"."team_members" (
    ...
    "role" "text" DEFAULT 'member'::"text" NOT NULL,
    "joined_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "team_members_role_check" CHECK (("role" = ANY (ARRAY['leader'::"text", 'member'::"text", 'agent'::"text", 'judge'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "actors"."teams" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "teams_visibility_check" CHECK (("visibility" = ANY (ARRAY['public'::"text", 'private'::"text", 'invite_only'::"text"])))
);
...
COMMENT ON TABLE "agents"."agent_adapters" IS 'Agent runtime adapter configurations. Moved from battles.agent_adapters in migration 27.';



COMMENT ON COLUMN "agents"."agent_adapters"."definition_id" IS 'Optional FK to agents.agent_definitions when this adapter backs a structured agent.';
...
CREATE TABLE IF NOT EXISTS "agents"."agent_instances" (
    ...
    "actor_id" "uuid",
    "display_name" "text" NOT NULL,
    "runtime_mode" "text" DEFAULT 'cloud'::"text" NOT NULL,
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "agent_instances_cloud_needs_byok_or_credit" CHECK ((("runtime_mode" <> 'cloud'::"text") OR true)),
    CONSTRAINT "agent_instances_local_needs_profile" CHECK ((("runtime_mode" <> ALL (ARRAY['local'::"text", 'hybrid'::"text"])) OR ("local_profile_id" IS NOT NULL))),
    CONSTRAINT "agent_instances_runtime_mode_check" CHECK (("runtime_mode" = ANY (ARRAY['cloud'::"text", 'local'::"text", 'hybrid'::"text"])))
);
...
COMMENT ON TABLE "agents"."agent_instances" IS 'Deployed agent instances. Each instance is linked to an actor, has BYOK config, and can run in cloud, local, or hybrid mode.';



COMMENT ON COLUMN "agents"."agent_instances"."byok_key_ref_id" IS 'NULL = use platform credit. Non-null = use this BYOK key for execution funding.';



COMMENT ON COLUMN "agents"."agent_instances"."local_profile_id" IS 'Required for local/hybrid runtime_mode. Links to local_runtime_profiles.';
...
COMMENT ON TABLE "agents"."agent_productivity_scopes" IS 'Scopes an agent definition to specific platform apps (arena, forum, cli, etc.).';
...
COMMENT ON TABLE "agents"."agent_versions" IS 'Immutable versioned snapshots of agent_definitions. Append-only — used for battle reproducibility.';
...
CREATE TABLE IF NOT EXISTS "agents"."byok_key_refs" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "byok_key_refs_scope_check" CHECK (("scope" = ANY (ARRAY['agent'::"text", 'user'::"text", 'team'::"text"]))),
    CONSTRAINT "byok_key_refs_status_check" CHECK (("status" = ANY (ARRAY['active'::"text", 'revoked'::"text", 'expired'::"text"])))
);
...
COMMENT ON TABLE "agents"."byok_key_refs" IS 'Cloud BYOK key metadata. OSS-safe: vault_secret_name is opaque reference. Actual keys live in Supabase Vault via vault.create_secret(), NEVER in Postgres.';



COMMENT ON COLUMN "agents"."byok_key_refs"."vault_secret_name" IS 'Reference to Supabase Vault secret (pg_secrets). Never expose via RLS SELECT to end users.';



COMMENT ON COLUMN "agents"."byok_key_refs"."key_prefix" IS 'First 4-8 chars of the key for user identification only. e.g. sk-an...';



COMMENT ON COLUMN "agents"."byok_key_refs"."scope" IS 'agent = single agent; user = all user agents; team = shared across team members.';



COMMENT ON COLUMN "agents"."byok_key_refs"."scoped_entity_id" IS 'Polymorphic: agents.agent_instances.id (scope=agent) or actors.teams actor_id (scope=team).';



CREATE OR REPLACE VIEW "agents"."byok_key_refs_safe" AS
 SELECT "byok_key_refs"."id",
    "byok_key_refs"."owner_lenser_id",
    "byok_key_refs"."provider_id",
    "byok_key_refs"."display_label",
    "byok_key_refs"."key_prefix",
    "byok_key_refs"."scope",
    "byok_key_refs"."scoped_entity_id",
    "byok_key_refs"."status",
    "byok_key_refs"."last_used_at",
    "byok_key_refs"."expires_at",
    "byok_key_refs"."created_at",
    "byok_key_refs"."updated_at"
   FROM "agents"."byok_key_refs";


ALTER TABLE "agents"."byok_key_refs_safe" OWNER TO "postgres";


COMMENT ON VIEW "agents"."byok_key_refs_safe" IS 'Safe view of byok_key_refs with vault_secret_name excluded. Use this for PostgREST access.';
...
CREATE TABLE IF NOT EXISTS "agents"."local_runtime_profiles" (
    ...
    "local_profile_token" "text" NOT NULL,
...
COMMENT ON TABLE "agents"."local_runtime_profiles" IS 'Local/self-hosted agent runtime profiles. OSS-safe: no cloud secrets. signing_key_hash = SHA-256 of local signing key for HMAC verification of synced results.';



COMMENT ON COLUMN "agents"."local_runtime_profiles"."local_profile_token" IS 'Stable opaque token that identifies this local runtime to the cloud without revealing secrets.';



COMMENT ON COLUMN "agents"."local_runtime_profiles"."signing_key_hash" IS 'SHA-256 hash of local HMAC signing key. Used to verify execution_runs.execution_hash on sync. Actual signing key lives ONLY on the local machine.';
...
CREATE TABLE IF NOT EXISTS "ai"."execution_margin_policies" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "margin_policies_markup_nonneg" CHECK ((("markup_percent" >= (0)::numeric) AND ("fixed_fee_usd" >= (0)::numeric))),
    CONSTRAINT "margin_policies_max_gte_min" CHECK ((("max_charge_credits" IS NULL) OR ("max_charge_credits" >= "min_charge_credits"))),
    CONSTRAINT "margin_policies_min_credits_nonneg" CHECK (("min_charge_credits" >= 0)),
    CONSTRAINT "margin_policies_rounding_check" CHECK (("rounding_mode" = ANY (ARRAY['ceil'::"text", 'floor'::"text", 'round'::"text"])))
);
...
COMMENT ON TABLE "ai"."execution_margin_policies" IS 'Platform markup policies applied on provider cost. model_id=NULL = global default. SERVICE_ROLE ONLY.';
...
COMMENT ON TABLE "ai"."feature_model_policies" IS 'Routes platform feature keys to specific AI models. Lower priority = higher preference.';



COMMENT ON COLUMN "ai"."feature_model_policies"."conditions" IS 'Runtime conditions for this routing rule, e.g. {"min_context_tokens": 100000}.';
...
COMMENT ON TABLE "audit"."admin_actions" IS 'Admin operations audit log. Append-only. Every admin action must be logged here.';
...
CREATE TABLE IF NOT EXISTS "audit"."events" (
    ...
    "entity_table" "text",
    "entity_id" "uuid",
    "actor_lenser_id" "uuid",
    "actor_actor_id" "uuid",
    "ip_hash" "text",
    "user_agent_hash" "text",
    "payload" "jsonb" DEFAULT '{}'::"jsonb" NOT NULL,
    "severity" "text" DEFAULT 'info'::"text" NOT NULL,
    CONSTRAINT "events_severity_check" CHECK (("severity" = ANY (ARRAY['info'::"text", 'warn'::"text", 'error'::"text", 'critical'::"text"])))
);
...
COMMENT ON TABLE "audit"."events" IS 'Core immutable event log. Append-only. Partition by occurred_at when row count exceeds ~10M rows.';



COMMENT ON COLUMN "audit"."events"."ip_hash" IS 'SHA-256 of client IP. GDPR-safe: not reversible without rainbow table. Never store raw IP.';



COMMENT ON COLUMN "audit"."events"."payload" IS 'Non-sensitive event details. MUST NOT contain API keys, tokens, or PII.';
...
CREATE TABLE IF NOT EXISTS "audit"."moderation_decisions" (
    ...
    "appeal_outcome" "text",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "moderation_decisions_ai_confidence_range" CHECK ((("ai_confidence" IS NULL) OR (("ai_confidence" >= (0)::numeric) AND ("ai_confidence" <= (1)::numeric)))),
    CONSTRAINT "moderation_decisions_appeal_outcome_check" CHECK ((("appeal_outcome" IS NULL) OR ("appeal_outcome" = ANY (ARRAY['upheld'::"text", 'overturned'::"text", 'pending'::"text"])))),
    CONSTRAINT "moderation_decisions_type_check" CHECK (("decision_type" = ANY (ARRAY['approved'::"text", 'rejected'::"text", 'flagged'::"text", 'removed'::"text", 'restored'::"text", 'warned'::"text"])))
);
...
COMMENT ON TABLE "audit"."moderation_decisions" IS 'Moderation log for content, battles, and actors. Includes appeal tracking.';
...
CREATE TABLE IF NOT EXISTS "audit"."security_events" (
    ...
    "ip_hash" "text",
    "severity" "text" DEFAULT 'info'::"text" NOT NULL,
    CONSTRAINT "security_events_severity_check" CHECK (("severity" = ANY (ARRAY['info'::"text", 'warn'::"text", 'error'::"text", 'critical'::"text"]))),
    CONSTRAINT "security_events_type_check" CHECK (("event_type" = ANY (ARRAY['byok_key_registered'::"text", 'byok_key_revoked'::"text", 'byok_key_rotated'::"text", 'byok_key_used'::"text", 'byok_key_expired'::"text", 'local_agent_synced'::"text", 'local_agent_hmac_verified'::"text", 'local_agent_hmac_failed'::"text", 'suspicious_activity'::"text", 'rate_limit_exceeded'::"text", 'unauthorized_access_attempt'::"text"])))
);
...
COMMENT ON TABLE "audit"."security_events" IS 'BYOK lifecycle and security event log. Append-only. key_ref_id references agents.byok_key_refs; vault_secret_name is never stored here.';



COMMENT ON COLUMN "audit"."security_events"."metadata" IS 'Non-sensitive metadata only. No vault names, no raw keys, no tokens.';
...
CREATE TABLE IF NOT EXISTS "battles"."contenders" (
    ...
    "actor_id" "uuid",
    "team_id" "uuid",
    "entry_mode" "text" DEFAULT 'direct'::"text" NOT NULL,
    "contender_status" "text" DEFAULT 'active'::"text" NOT NULL,
    "joined_at" timestamp with time zone DEFAULT "now"(),
    "accepted_at" timestamp with time zone,
    "withdrawn_at" timestamp with time zone,
    CONSTRAINT "contenders_entry_mode_check" CHECK (("entry_mode" = ANY (ARRAY['direct'::"text", 'invited'::"text", 'qualified'::"text", 'wildcard'::"text", 'auto_join'::"text"]))),
    CONSTRAINT "contenders_slot_letter" CHECK ((("slot" >= 'A'::"bpchar") AND ("slot" <= 'Z'::"bpchar"))),
    CONSTRAINT "contenders_status_check" CHECK (("contender_status" = ANY (ARRAY['pending'::"text", 'accepted'::"text", 'active'::"text", 'withdrawn'::"text", 'disqualified'::"text", 'eliminated'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "battles"."submissions" (
    ...
    CONSTRAINT "submissions_source_type_check" CHECK (("source_type" = ANY (ARRAY['manual'::"text", 'execution_output'::"text", 'hybrid'::"text", 'imported'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "battles"."votes" (
    ...
    "rationale" "text",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "voted_contender_id" "uuid",
    "is_draw" boolean DEFAULT false NOT NULL,
    "voter_actor_id" "uuid",
    "weight" numeric DEFAULT 1.0 NOT NULL,
    "is_ai_vote" boolean DEFAULT false NOT NULL
);
...
COMMENT ON TABLE "content"."media_library" IS 'Media asset storage for user-uploaded files. ai.generations has been dropped; use execution.artifacts for AI execution outputs.';
...
COMMENT ON COLUMN "execution"."artifacts"."media_id" IS 'Deprecated reference to content.media_library. FK removed in migration 26. Column kept for backward compat; prefer content_text or content_json for new artifacts.';
...
CREATE TABLE IF NOT EXISTS "execution"."links" (
    ...
    "entity_id" "uuid" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "links_entity_type_check" CHECK (("entity_type" = ANY (ARRAY['battle'::"text", 'submission'::"text", 'thread'::"text", 'prompt_template'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "execution"."requests" (
    ...
    CONSTRAINT "requests_origin_type_check" CHECK (("origin_type" = ANY (ARRAY['battle'::"text", 'content_preview'::"text", 'template_test'::"text", 'forum'::"text", 'api'::"text", 'cli'::"text"]))),
...
CREATE TABLE IF NOT EXISTS "execution"."steps" (
    ...
    CONSTRAINT "steps_step_type_check" CHECK (("step_type" = ANY (ARRAY['prompt'::"text", 'tool_call'::"text", 'tool_result'::"text", 'model_call'::"text", 'judge_call'::"text", 'retrieval'::"text", 'transform'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "lensers"."account_lifecycle_audit" (
    ...
    "metadata" "jsonb" DEFAULT '{}'::"jsonb" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "account_lifecycle_audit_actor_source_check" CHECK (("actor_source" = ANY (ARRAY['user_action'::"text", 'signin_restore'::"text", 'system_job'::"text"]))),
    CONSTRAINT "account_lifecycle_audit_event_type_check" CHECK (("event_type" = ANY (ARRAY['deletion_scheduled'::"text", 'account_deactivated'::"text", 'restored_from_pending_deletion'::"text", 'restored_from_deactivated'::"text", 'deletion_completed'::"text"])))
);
...
CREATE OR REPLACE VIEW "public"."vw_battle_funnel" WITH ("security_invoker"='on') AS
...
CREATE OR REPLACE VIEW "public"."vw_battle_health" WITH ("security_invoker"='on') AS
 SELECT "b"."id",
    "b"."title",
    "b"."slug",
    "b"."status",
...
CREATE OR REPLACE VIEW "public"."vw_prompt_templates_public" WITH ("security_invoker"='on') AS
 SELECT "pt"."id",
    "pt"."lenser_id",
    "prof"."handle" AS "lenser_handle",
    "pt"."visibility",
...
CREATE TABLE IF NOT EXISTS "xp"."apps" (
    ...
    "slug" "text" NOT NULL,
    "name" "text" NOT NULL,
    "difficulty" "xp"."difficulty_enum" DEFAULT 'standard'::"xp"."difficulty_enum" NOT NULL,
    "is_active" boolean DEFAULT true NOT NULL,
    "metadata" "jsonb",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL
);
...
CREATE TABLE IF NOT EXISTS "xp"."difficulty_multipliers" (
    "difficulty" "xp"."difficulty_enum" NOT NULL,
...
CREATE TABLE IF NOT EXISTS "xp"."rules" (
    ...
    "is_active" boolean DEFAULT true NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "difficulty" "xp"."difficulty_enum" DEFAULT 'standard'::"xp"."difficulty_enum"
);
...
ALTER TABLE ONLY "actors"."actors"
    ADD CONSTRAINT "actors_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "actors"."communities"
    ADD CONSTRAINT "communities_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "actors"."community_members"
    ADD CONSTRAINT "community_members_pkey" PRIMARY KEY ("community_id", "actor_id");



ALTER TABLE ONLY "actors"."team_members"
    ADD CONSTRAINT "team_members_pkey" PRIMARY KEY ("team_id", "actor_id");



ALTER TABLE ONLY "actors"."teams"
    ADD CONSTRAINT "teams_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "agents"."agent_adapters"
    ADD CONSTRAINT "agent_adapters_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "agents"."agent_definitions"
    ADD CONSTRAINT "agent_definitions_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "agents"."agent_definitions"
    ADD CONSTRAINT "agent_definitions_slug_unique" UNIQUE ("slug");



ALTER TABLE ONLY "agents"."agent_instances"
    ADD CONSTRAINT "agent_instances_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "agents"."agent_productivity_scopes"
    ADD CONSTRAINT "agent_productivity_scopes_def_app_unique" UNIQUE ("definition_id", "app_id");



ALTER TABLE ONLY "agents"."agent_productivity_scopes"
    ADD CONSTRAINT "agent_productivity_scopes_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "agents"."agent_tool_allowlist"
    ADD CONSTRAINT "agent_tool_allowlist_def_tool_unique" UNIQUE ("definition_id", "tool_id");
...
ALTER TABLE ONLY "agents"."agent_versions"
    ADD CONSTRAINT "agent_versions_def_version_unique" UNIQUE ("definition_id", "version_number");
...
ALTER TABLE ONLY "agents"."byok_key_refs"
    ADD CONSTRAINT "byok_key_refs_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "agents"."local_runtime_profiles"
    ADD CONSTRAINT "local_runtime_profiles_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "agents"."local_runtime_profiles"
    ADD CONSTRAINT "local_runtime_profiles_token_unique" UNIQUE ("local_profile_token");



ALTER TABLE ONLY "agents"."tools"
...
ALTER TABLE ONLY "ai"."execution_margin_policies"
    ADD CONSTRAINT "execution_margin_policies_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "ai"."feature_model_policies"
    ADD CONSTRAINT "feature_model_policies_feature_model_unique" UNIQUE ("feature_key", "model_id");



ALTER TABLE ONLY "ai"."feature_model_policies"
    ADD CONSTRAINT "feature_model_policies_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "audit"."admin_actions"
...
ALTER TABLE ONLY "audit"."moderation_decisions"
...
ALTER TABLE ONLY "battles"."vote_aggregates"
    ADD CONSTRAINT "vote_aggregates_pkey" PRIMARY KEY ("battle_id", "contender_id");



ALTER TABLE ONLY "battles"."vote_choices"
    ADD CONSTRAINT "vote_choices_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "execution"."links"
...
ALTER TABLE ONLY "lensers"."account_lifecycle_audit"
    ADD CONSTRAINT "account_lifecycle_audit_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "xp"."contributions"
    ADD CONSTRAINT "contributions_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "xp"."difficulty_multipliers"
    ADD CONSTRAINT "difficulty_multipliers_pkey" PRIMARY KEY ("difficulty");
...
ALTER TABLE ONLY "xp"."rules"
    ADD CONSTRAINT "xp_rules_app_action_key" UNIQUE ("app_id", "action_key");
...
CREATE INDEX "idx_actors_agent_instance" ON "actors"."actors" USING "btree" ("agent_instance_id") WHERE ("agent_instance_id" IS NOT NULL);



CREATE INDEX "idx_actors_model" ON "actors"."actors" USING "btree" ("ai_model_id") WHERE ("ai_model_id" IS NOT NULL);



CREATE INDEX "idx_actors_owner" ON "actors"."actors" USING "btree" ("owner_lenser_id", "actor_type") WHERE ("owner_lenser_id" IS NOT NULL);



CREATE UNIQUE INDEX "idx_actors_profile_unique" ON "actors"."actors" USING "btree" ("profile_id") WHERE ("profile_id" IS NOT NULL);



CREATE INDEX "idx_actors_type_created" ON "actors"."actors" USING "btree" ("actor_type", "created_at" DESC);



CREATE UNIQUE INDEX "idx_communities_actor" ON "actors"."communities" USING "btree" ("actor_id");



CREATE INDEX "idx_communities_owner" ON "actors"."communities" USING "btree" ("owner_lenser_id");



CREATE UNIQUE INDEX "idx_communities_slug" ON "actors"."communities" USING "btree" ("slug");



CREATE INDEX "idx_community_members_actor" ON "actors"."community_members" USING "btree" ("actor_id");



CREATE INDEX "idx_community_members_role" ON "actors"."community_members" USING "btree" ("community_id", "role");



CREATE INDEX "idx_team_members_actor" ON "actors"."team_members" USING "btree" ("actor_id");



CREATE INDEX "idx_team_members_role" ON "actors"."team_members" USING "btree" ("team_id", "role");



CREATE UNIQUE INDEX "idx_teams_actor" ON "actors"."teams" USING "btree" ("actor_id");



CREATE INDEX "idx_teams_owner" ON "actors"."teams" USING "btree" ("owner_actor_id");



CREATE UNIQUE INDEX "idx_teams_slug" ON "actors"."teams" USING "btree" ("slug");



CREATE INDEX "idx_agent_definitions_owner" ON "agents"."agent_definitions" USING "btree" ("owner_lenser_id");



CREATE INDEX "idx_agent_definitions_public" ON "agents"."agent_definitions" USING "btree" ("is_public", "is_active") WHERE (("is_public" = true) AND ("is_active" = true));



CREATE INDEX "idx_agent_definitions_slug_trgm" ON "agents"."agent_definitions" USING "gin" ("slug" "extensions"."gin_trgm_ops") WHERE ("is_active" = true);



CREATE INDEX "idx_agent_instances_actor" ON "agents"."agent_instances" USING "btree" ("actor_id") WHERE ("actor_id" IS NOT NULL);



CREATE INDEX "idx_agent_instances_byok_key" ON "agents"."agent_instances" USING "btree" ("byok_key_ref_id") WHERE ("byok_key_ref_id" IS NOT NULL);



CREATE INDEX "idx_agent_instances_definition" ON "agents"."agent_instances" USING "btree" ("definition_id", "is_active");



CREATE INDEX "idx_agent_instances_owner" ON "agents"."agent_instances" USING "btree" ("owner_lenser_id");



CREATE INDEX "idx_agent_instances_owner_active" ON "agents"."agent_instances" USING "btree" ("owner_lenser_id") WHERE ("is_active" = true);



CREATE INDEX "idx_agent_productivity_scopes_app" ON "agents"."agent_productivity_scopes" USING "btree" ("app_id", "is_active");



CREATE INDEX "idx_agent_tool_allowlist_definition" ON "agents"."agent_tool_allowlist" USING "btree" ("definition_id");



CREATE INDEX "idx_agent_versions_definition" ON "agents"."agent_versions" USING "btree" ("definition_id", "version_number" DESC);



CREATE INDEX "idx_agents_adapters_owner" ON "agents"."agent_adapters" USING "btree" ("owner_lenser_id", "is_active");



CREATE INDEX "idx_agents_adapters_type" ON "agents"."agent_adapters" USING "btree" ("adapter_type", "is_active");



CREATE INDEX "idx_byok_key_refs_owner_status" ON "agents"."byok_key_refs" USING "btree" ("owner_lenser_id", "status");



CREATE INDEX "idx_byok_key_refs_provider_active" ON "agents"."byok_key_refs" USING "btree" ("provider_id", "owner_lenser_id") WHERE ("status" = 'active'::"text");



CREATE INDEX "idx_byok_key_refs_provider_status" ON "agents"."byok_key_refs" USING "btree" ("provider_id", "status");



CREATE INDEX "idx_byok_key_refs_vault_name" ON "agents"."byok_key_refs" USING "btree" ("vault_secret_name");



CREATE INDEX "idx_local_runtime_profiles_owner" ON "agents"."local_runtime_profiles" USING "btree" ("owner_lenser_id");



CREATE INDEX "idx_ai_feature_policies_key_active" ON "ai"."feature_model_policies" USING "btree" ("feature_key", "priority") WHERE ("is_active" = true);



CREATE INDEX "idx_ai_margin_policies_active" ON "ai"."execution_margin_policies" USING "btree" ("model_id", "is_active") WHERE (("is_active" = true) AND ("effective_to" IS NULL));
...
CREATE UNIQUE INDEX "idx_ai_models_model_key" ON "ai"."models" USING "btree" ("model_key") WHERE ("model_key" IS NOT NULL);
...
CREATE INDEX "idx_audit_admin_actions_admin" ON "audit"."admin_actions" USING "btree" ("admin_lenser_id", "occurred_at" DESC);



CREATE INDEX "idx_audit_admin_actions_target" ON "audit"."admin_actions" USING "btree" ("target_entity_type", "target_entity_id");



CREATE INDEX "idx_audit_admin_actions_type" ON "audit"."admin_actions" USING "btree" ("action_type", "occurred_at" DESC);



CREATE INDEX "idx_audit_events_actor" ON "audit"."events" USING "btree" ("actor_lenser_id", "occurred_at" DESC) WHERE ("actor_lenser_id" IS NOT NULL);



CREATE INDEX "idx_audit_events_entity" ON "audit"."events" USING "btree" ("entity_schema", "entity_table", "entity_id");



CREATE INDEX "idx_audit_events_entity_time" ON "audit"."events" USING "btree" ("entity_id", "occurred_at" DESC) WHERE ("entity_id" IS NOT NULL);



CREATE INDEX "idx_audit_events_severity" ON "audit"."events" USING "btree" ("severity", "occurred_at" DESC) WHERE ("severity" = ANY (ARRAY['warn'::"text", 'error'::"text", 'critical'::"text"]));



CREATE INDEX "idx_audit_events_type_time" ON "audit"."events" USING "btree" ("event_type", "occurred_at" DESC);



CREATE INDEX "idx_audit_mod_decisions_moderator" ON "audit"."moderation_decisions" USING "btree" ("moderator_lenser_id", "occurred_at" DESC) WHERE ("moderator_lenser_id" IS NOT NULL);



CREATE INDEX "idx_audit_mod_decisions_target" ON "audit"."moderation_decisions" USING "btree" ("target_entity_schema", "target_entity_table", "target_entity_id");



CREATE INDEX "idx_audit_mod_decisions_type_time" ON "audit"."moderation_decisions" USING "btree" ("decision_type", "occurred_at" DESC);



CREATE INDEX "idx_audit_security_events_critical" ON "audit"."security_events" USING "btree" ("occurred_at" DESC) WHERE ("severity" = ANY (ARRAY['error'::"text", 'critical'::"text"]));



CREATE INDEX "idx_audit_security_events_key_ref" ON "audit"."security_events" USING "btree" ("key_ref_id", "occurred_at" DESC) WHERE ("key_ref_id" IS NOT NULL);



CREATE INDEX "idx_audit_security_events_lenser" ON "audit"."security_events" USING "btree" ("lenser_id", "occurred_at" DESC) WHERE ("lenser_id" IS NOT NULL);



CREATE INDEX "idx_audit_security_events_type" ON "audit"."security_events" USING "btree" ("event_type", "occurred_at" DESC);



CREATE INDEX "idx_contenders_actor_joined" ON "battles"."contenders" USING "btree" ("actor_id", "joined_at" DESC) WHERE ("actor_id" IS NOT NULL);



CREATE UNIQUE INDEX "idx_contenders_battle_actor" ON "battles"."contenders" USING "btree" ("battle_id", "actor_id") WHERE (("actor_id" IS NOT NULL) AND ("team_id" IS NULL));



CREATE INDEX "idx_contenders_battle_status" ON "battles"."contenders" USING "btree" ("battle_id", "contender_status");



CREATE UNIQUE INDEX "idx_contenders_battle_team" ON "battles"."contenders" USING "btree" ("battle_id", "team_id") WHERE ("team_id" IS NOT NULL);



CREATE UNIQUE INDEX "idx_submissions_battle_contender_final" ON "battles"."submissions" USING "btree" ("battle_id", "contender_id") WHERE ("is_final" = true);



CREATE INDEX "idx_submissions_contender_time" ON "battles"."submissions" USING "btree" ("contender_id", "submitted_at" DESC);



CREATE UNIQUE INDEX "idx_submissions_execution_run" ON "battles"."submissions" USING "btree" ("execution_run_id") WHERE ("execution_run_id" IS NOT NULL);



CREATE INDEX "idx_vote_aggregates_rank" ON "battles"."vote_aggregates" USING "btree" ("battle_id", "rank_position");



CREATE INDEX "idx_vote_aggregates_score" ON "battles"."vote_aggregates" USING "btree" ("battle_id", "weighted_vote_sum" DESC);



CREATE INDEX "idx_vote_choices_contender" ON "battles"."vote_choices" USING "btree" ("contender_id");



CREATE INDEX "idx_vote_choices_rank" ON "battles"."vote_choices" USING "btree" ("vote_id", "rank_ordinal") WHERE ("rank_ordinal" IS NOT NULL);



CREATE UNIQUE INDEX "idx_vote_choices_vote_contender" ON "battles"."vote_choices" USING "btree" ("vote_id", "contender_id");



CREATE INDEX "idx_votes_battle_created" ON "battles"."votes" USING "btree" ("battle_id", "created_at" DESC);



CREATE INDEX "idx_votes_contender" ON "battles"."votes" USING "btree" ("voted_contender_id") WHERE ("voted_contender_id" IS NOT NULL);



CREATE INDEX "idx_votes_voter_actor" ON "battles"."votes" USING "btree" ("voter_actor_id") WHERE ("voter_actor_id" IS NOT NULL);
...
CREATE INDEX "idx_prompt_reactions_created_at_prompt_id" ON "content"."prompt_reactions" USING "btree" ("created_at", "prompt_id");
...
CREATE INDEX "idx_prompt_templates_public_created" ON "content"."prompt_templates" USING "btree" ("created_at" DESC) WHERE (("visibility" = 'public'::"content"."visibility_enum") AND ("status" = 'published'::"content"."content_status"));
...
CREATE INDEX "idx_prompt_translations_title_trgm" ON "content"."prompt_translations" USING "gin" ("lower"("title") "extensions"."gin_trgm_ops") WHERE ("is_original" = true);
...
CREATE INDEX "idx_thread_reactions_created_at_thread_id" ON "content"."thread_reactions" USING "btree" ("created_at", "thread_id");
...
CREATE INDEX "idx_exec_links_entity" ON "execution"."links" USING "btree" ("entity_type", "entity_id");



CREATE INDEX "idx_exec_links_run" ON "execution"."links" USING "btree" ("run_id");



CREATE UNIQUE INDEX "idx_exec_links_unique" ON "execution"."links" USING "btree" ("run_id", "entity_type", "entity_id");



CREATE INDEX "idx_exec_requests_adapter" ON "execution"."requests" USING "btree" ("agent_adapter_id", "created_at" DESC) WHERE ("agent_adapter_id" IS NOT NULL);
...
CREATE INDEX "idx_exec_requests_requester" ON "execution"."requests" USING "btree" ("requester_lenser_id", "created_at" DESC);
...
CREATE INDEX "idx_exec_runs_adapter" ON "execution"."runs" USING "btree" ("agent_adapter_id", "started_at" DESC) WHERE ("agent_adapter_id" IS NOT NULL);
...
CREATE INDEX "idx_account_lifecycle_audit_profile_created_at" ON "lensers"."account_lifecycle_audit" USING "btree" ("profile_id", "created_at" DESC);



CREATE INDEX "idx_account_lifecycle_audit_user_created_at" ON "lensers"."account_lifecycle_audit" USING "btree" ("user_id", "created_at" DESC);
...
CREATE INDEX "idx_contributions_context" ON "xp"."contributions" USING "btree" ("context");



CREATE INDEX "idx_contributions_lenser" ON "xp"."contributions" USING "btree" ("lenser_id");



CREATE INDEX "idx_xp_totals_app_id_total_xp_desc" ON "xp"."totals" USING "btree" ("app_id", "total_xp" DESC);
...
CREATE OR REPLACE TRIGGER "trg_agent_adapters_updated_at" BEFORE UPDATE ON "agents"."agent_adapters" FOR EACH ROW EXECUTE FUNCTION "agents"."set_updated_at"();



CREATE OR REPLACE TRIGGER "trg_agent_definitions_updated_at" BEFORE UPDATE ON "agents"."agent_definitions" FOR EACH ROW EXECUTE FUNCTION "agents"."set_updated_at"();



CREATE OR REPLACE TRIGGER "trg_agent_instances_updated_at" BEFORE UPDATE ON "agents"."agent_instances" FOR EACH ROW EXECUTE FUNCTION "agents"."set_updated_at"();



CREATE OR REPLACE TRIGGER "trg_byok_key_refs_updated_at" BEFORE UPDATE ON "agents"."byok_key_refs" FOR EACH ROW EXECUTE FUNCTION "agents"."set_updated_at"();



CREATE OR REPLACE TRIGGER "trg_ai_feature_policies_updated_at" BEFORE UPDATE ON "ai"."feature_model_policies" FOR EACH ROW EXECUTE FUNCTION "battles"."set_updated_at"();



CREATE OR REPLACE TRIGGER "trg_ai_margin_policies_updated_at" BEFORE UPDATE ON "ai"."execution_margin_policies" FOR EACH ROW EXECUTE FUNCTION "battles"."set_updated_at"();
...
CREATE OR REPLACE TRIGGER "trg_prevent_delete_admin" BEFORE DELETE ON "audit"."admin_actions" FOR EACH ROW EXECUTE FUNCTION "audit"."trg_prevent_delete"();



CREATE OR REPLACE TRIGGER "trg_prevent_delete_events" BEFORE DELETE ON "audit"."events" FOR EACH ROW EXECUTE FUNCTION "audit"."trg_prevent_delete"();



CREATE OR REPLACE TRIGGER "trg_prevent_delete_moderation" BEFORE DELETE ON "audit"."moderation_decisions" FOR EACH ROW EXECUTE FUNCTION "audit"."trg_prevent_delete"();
...
CREATE OR REPLACE TRIGGER "trg_battle_status_audit" AFTER UPDATE ON "battles"."battles" FOR EACH ROW WHEN (("old"."status" IS DISTINCT FROM "new"."status")) EXECUTE FUNCTION "audit"."trg_battle_status_audit"();
...
CREATE OR REPLACE TRIGGER "trg_submissions_validate_execution_link" BEFORE INSERT OR UPDATE ON "battles"."submissions" FOR EACH ROW EXECUTE FUNCTION "battles"."trg_submissions_validate_execution_link"();
...
CREATE OR REPLACE TRIGGER "trg_auto_create_actor_for_profile" AFTER INSERT ON "lensers"."profiles" FOR EACH ROW EXECUTE FUNCTION "actors"."trg_auto_create_actor_for_profile"();
...
ALTER TABLE ONLY "actors"."actors"
    ADD CONSTRAINT "actors_agent_adapter_id_fkey" FOREIGN KEY ("agent_adapter_id") REFERENCES "agents"."agent_adapters"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "actors"."actors"
    ADD CONSTRAINT "actors_agent_instance_id_fkey" FOREIGN KEY ("agent_instance_id") REFERENCES "agents"."agent_instances"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "actors"."actors"
    ADD CONSTRAINT "actors_ai_model_id_fkey" FOREIGN KEY ("ai_model_id") REFERENCES "ai"."models"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "actors"."actors"
    ADD CONSTRAINT "actors_owner_lenser_id_fkey" FOREIGN KEY ("owner_lenser_id") REFERENCES "lensers"."profiles"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "actors"."actors"
    ADD CONSTRAINT "actors_profile_id_fkey" FOREIGN KEY ("profile_id") REFERENCES "lensers"."profiles"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "actors"."communities"
    ADD CONSTRAINT "communities_actor_id_fkey" FOREIGN KEY ("actor_id") REFERENCES "actors"."actors"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "actors"."communities"
    ADD CONSTRAINT "communities_owner_lenser_id_fkey" FOREIGN KEY ("owner_lenser_id") REFERENCES "lensers"."profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "actors"."community_members"
    ADD CONSTRAINT "community_members_actor_id_fkey" FOREIGN KEY ("actor_id") REFERENCES "actors"."actors"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "actors"."community_members"
    ADD CONSTRAINT "community_members_community_id_fkey" FOREIGN KEY ("community_id") REFERENCES "actors"."communities"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "actors"."team_members"
    ADD CONSTRAINT "team_members_actor_id_fkey" FOREIGN KEY ("actor_id") REFERENCES "actors"."actors"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "actors"."team_members"
    ADD CONSTRAINT "team_members_team_id_fkey" FOREIGN KEY ("team_id") REFERENCES "actors"."teams"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "actors"."teams"
    ADD CONSTRAINT "teams_actor_id_fkey" FOREIGN KEY ("actor_id") REFERENCES "actors"."actors"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "actors"."teams"
    ADD CONSTRAINT "teams_owner_actor_id_fkey" FOREIGN KEY ("owner_actor_id") REFERENCES "actors"."actors"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "agents"."agent_adapters"
    ADD CONSTRAINT "agent_adapters_definition_fkey" FOREIGN KEY ("definition_id") REFERENCES "agents"."agent_definitions"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "agents"."agent_adapters"
    ADD CONSTRAINT "agent_adapters_owner_fkey" FOREIGN KEY ("owner_lenser_id") REFERENCES "lensers"."profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "agents"."agent_definitions"
    ADD CONSTRAINT "agent_definitions_adapter_fkey" FOREIGN KEY ("adapter_id") REFERENCES "agents"."agent_adapters"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "agents"."agent_definitions"
    ADD CONSTRAINT "agent_definitions_model_fkey" FOREIGN KEY ("model_id") REFERENCES "ai"."models"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "agents"."agent_definitions"
    ADD CONSTRAINT "agent_definitions_owner_fkey" FOREIGN KEY ("owner_lenser_id") REFERENCES "lensers"."profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "agents"."agent_instances"
    ADD CONSTRAINT "agent_instances_actor_fkey" FOREIGN KEY ("actor_id") REFERENCES "actors"."actors"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "agents"."agent_instances"
    ADD CONSTRAINT "agent_instances_adapter_fkey" FOREIGN KEY ("adapter_id") REFERENCES "agents"."agent_adapters"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "agents"."agent_instances"
    ADD CONSTRAINT "agent_instances_byok_key_fkey" FOREIGN KEY ("byok_key_ref_id") REFERENCES "agents"."byok_key_refs"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "agents"."agent_instances"
    ADD CONSTRAINT "agent_instances_definition_fkey" FOREIGN KEY ("definition_id") REFERENCES "agents"."agent_definitions"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "agents"."agent_instances"
    ADD CONSTRAINT "agent_instances_local_profile_fkey" FOREIGN KEY ("local_profile_id") REFERENCES "agents"."local_runtime_profiles"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "agents"."agent_instances"
    ADD CONSTRAINT "agent_instances_owner_fkey" FOREIGN KEY ("owner_lenser_id") REFERENCES "lensers"."profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "agents"."agent_instances"
    ADD CONSTRAINT "agent_instances_version_fkey" FOREIGN KEY ("version_id") REFERENCES "agents"."agent_versions"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "agents"."agent_productivity_scopes"
    ADD CONSTRAINT "agent_productivity_scopes_app_fkey" FOREIGN KEY ("app_id") REFERENCES "xp"."apps"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "agents"."agent_productivity_scopes"
    ADD CONSTRAINT "agent_productivity_scopes_definition_fkey" FOREIGN KEY ("definition_id") REFERENCES "agents"."agent_definitions"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "agents"."agent_tool_allowlist"
    ADD CONSTRAINT "agent_tool_allowlist_definition_fkey" FOREIGN KEY ("definition_id") REFERENCES "agents"."agent_definitions"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "agents"."agent_tool_allowlist"
    ADD CONSTRAINT "agent_tool_allowlist_granted_by_fkey" FOREIGN KEY ("granted_by") REFERENCES "lensers"."profiles"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "agents"."agent_tool_allowlist"
    ADD CONSTRAINT "agent_tool_allowlist_tool_fkey" FOREIGN KEY ("tool_id") REFERENCES "agents"."tools"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "agents"."agent_versions"
    ADD CONSTRAINT "agent_versions_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "lensers"."profiles"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "agents"."agent_versions"
    ADD CONSTRAINT "agent_versions_definition_fkey" FOREIGN KEY ("definition_id") REFERENCES "agents"."agent_definitions"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "agents"."agent_versions"
    ADD CONSTRAINT "agent_versions_model_fkey" FOREIGN KEY ("model_id") REFERENCES "ai"."models"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "agents"."byok_key_refs"
    ADD CONSTRAINT "byok_key_refs_owner_fkey" FOREIGN KEY ("owner_lenser_id") REFERENCES "lensers"."profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "agents"."byok_key_refs"
    ADD CONSTRAINT "byok_key_refs_provider_fkey" FOREIGN KEY ("provider_id") REFERENCES "ai"."providers"("id") ON DELETE RESTRICT;



ALTER TABLE ONLY "agents"."local_runtime_profiles"
    ADD CONSTRAINT "local_runtime_profiles_owner_fkey" FOREIGN KEY ("owner_lenser_id") REFERENCES "lensers"."profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "ai"."feature_model_policies"
    ADD CONSTRAINT "feature_model_policies_model_fkey" FOREIGN KEY ("model_id") REFERENCES "ai"."models"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "ai"."execution_margin_policies"
    ADD CONSTRAINT "margin_policies_model_fkey" FOREIGN KEY ("model_id") REFERENCES "ai"."models"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "battles"."contenders"
    ADD CONSTRAINT "contenders_actor_id_fkey" FOREIGN KEY ("actor_id") REFERENCES "actors"."actors"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "battles"."contenders"
    ADD CONSTRAINT "contenders_adapter_fk" FOREIGN KEY ("agent_adapter_id") REFERENCES "agents"."agent_adapters"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "battles"."contenders"
    ADD CONSTRAINT "contenders_team_id_fkey" FOREIGN KEY ("team_id") REFERENCES "actors"."teams"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "battles"."submissions"
    ADD CONSTRAINT "submissions_adapter_id_fkey" FOREIGN KEY ("adapter_id") REFERENCES "agents"."agent_adapters"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "battles"."submissions"
    ADD CONSTRAINT "submissions_artifact_id_fkey" FOREIGN KEY ("artifact_id") REFERENCES "execution"."artifacts"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "battles"."submissions"
    ADD CONSTRAINT "submissions_execution_run_id_fkey" FOREIGN KEY ("execution_run_id") REFERENCES "execution"."runs"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "battles"."submissions"
    ADD CONSTRAINT "submissions_model_id_fkey" FOREIGN KEY ("model_id") REFERENCES "ai"."models"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "battles"."submissions"
    ADD CONSTRAINT "submissions_revision_of_id_fkey" FOREIGN KEY ("revision_of_id") REFERENCES "battles"."submissions"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "battles"."vote_aggregates"
    ADD CONSTRAINT "vote_aggregates_battle_id_fkey" FOREIGN KEY ("battle_id") REFERENCES "battles"."battles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "battles"."vote_aggregates"
    ADD CONSTRAINT "vote_aggregates_contender_id_fkey" FOREIGN KEY ("contender_id") REFERENCES "battles"."contenders"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "battles"."vote_choices"
    ADD CONSTRAINT "vote_choices_contender_id_fkey" FOREIGN KEY ("contender_id") REFERENCES "battles"."contenders"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "battles"."vote_choices"
    ADD CONSTRAINT "vote_choices_vote_id_fkey" FOREIGN KEY ("vote_id") REFERENCES "battles"."votes"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "battles"."votes"
    ADD CONSTRAINT "votes_voted_contender_id_fkey" FOREIGN KEY ("voted_contender_id") REFERENCES "battles"."contenders"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "battles"."votes"
    ADD CONSTRAINT "votes_voter_actor_id_fkey" FOREIGN KEY ("voter_actor_id") REFERENCES "actors"."actors"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "execution"."links"
    ADD CONSTRAINT "links_run_id_fkey" FOREIGN KEY ("run_id") REFERENCES "execution"."runs"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "execution"."requests"
    ADD CONSTRAINT "requests_agent_adapter_id_fkey" FOREIGN KEY ("agent_adapter_id") REFERENCES "agents"."agent_adapters"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "execution"."requests"
    ADD CONSTRAINT "requests_byok_key_ref_fkey" FOREIGN KEY ("byok_key_ref_id") REFERENCES "agents"."byok_key_refs"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "execution"."requests"
    ADD CONSTRAINT "requests_prompt_template_id_fkey" FOREIGN KEY ("prompt_template_id") REFERENCES "content"."prompt_templates"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "execution"."runs"
    ADD CONSTRAINT "runs_agent_adapter_id_fkey" FOREIGN KEY ("agent_adapter_id") REFERENCES "agents"."agent_adapters"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "lensers"."account_lifecycle_audit"
    ADD CONSTRAINT "account_lifecycle_audit_profile_id_fkey" FOREIGN KEY ("profile_id") REFERENCES "lensers"."profiles"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "xp"."contributions"
    ADD CONSTRAINT "contributions_lenser_id_fkey" FOREIGN KEY ("lenser_id") REFERENCES "lensers"."profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "xp"."contributions"
    ADD CONSTRAINT "contributions_xp_event_id_fkey" FOREIGN KEY ("xp_event_id") REFERENCES "xp"."events"("id") ON DELETE SET NULL;
...
CREATE POLICY "actors_insert_own" ON "actors"."actors" FOR INSERT TO "authenticated" WITH CHECK (("owner_lenser_id" = "lensers"."get_auth_lenser_id"()));



CREATE POLICY "actors_select_own" ON "actors"."actors" FOR SELECT TO "authenticated" USING (("owner_lenser_id" = "lensers"."get_auth_lenser_id"()));



CREATE POLICY "actors_select_public" ON "actors"."actors" FOR SELECT TO "authenticated" USING ((("status" = 'active'::"text") AND ("visibility" = ANY (ARRAY['public'::"text", 'community'::"text"]))));



CREATE POLICY "actors_select_public_anon" ON "actors"."actors" FOR SELECT TO "anon" USING ((("status" = 'active'::"text") AND ("visibility" = 'public'::"text")));



CREATE POLICY "actors_service_all" ON "actors"."actors" TO "service_role" USING (true) WITH CHECK (true);



CREATE POLICY "actors_update_own" ON "actors"."actors" FOR UPDATE TO "authenticated" USING (("owner_lenser_id" = "lensers"."get_auth_lenser_id"())) WITH CHECK (("owner_lenser_id" = "lensers"."get_auth_lenser_id"()));
...
CREATE POLICY "communities_insert_own" ON "actors"."communities" FOR INSERT TO "authenticated" WITH CHECK (("owner_lenser_id" = "lensers"."get_auth_lenser_id"()));



CREATE POLICY "communities_select_own" ON "actors"."communities" FOR SELECT TO "authenticated" USING (("owner_lenser_id" = "lensers"."get_auth_lenser_id"()));



CREATE POLICY "communities_select_public" ON "actors"."communities" FOR SELECT TO "authenticated" USING (("visibility" = 'public'::"text"));



CREATE POLICY "communities_service_all" ON "actors"."communities" TO "service_role" USING (true) WITH CHECK (true);



CREATE POLICY "communities_update_own" ON "actors"."communities" FOR UPDATE TO "authenticated" USING (("owner_lenser_id" = "lensers"."get_auth_lenser_id"())) WITH CHECK (("owner_lenser_id" = "lensers"."get_auth_lenser_id"()));
...
CREATE POLICY "community_members_select_member" ON "actors"."community_members" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "actors"."actors" "a"
  WHERE (("a"."id" = "community_members"."actor_id") AND ("a"."owner_lenser_id" = "lensers"."get_auth_lenser_id"())))));



CREATE POLICY "community_members_select_owner" ON "actors"."community_members" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "actors"."communities" "c"
  WHERE (("c"."id" = "community_members"."community_id") AND ("c"."owner_lenser_id" = "lensers"."get_auth_lenser_id"())))));



CREATE POLICY "community_members_service_all" ON "actors"."community_members" TO "service_role" USING (true) WITH CHECK (true);
...
CREATE POLICY "team_members_select_leader" ON "actors"."team_members" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM ("actors"."teams" "t"
     JOIN "actors"."actors" "a" ON (("a"."id" = "t"."owner_actor_id")))
  WHERE (("t"."id" = "team_members"."team_id") AND ("a"."owner_lenser_id" = "lensers"."get_auth_lenser_id"())))));



CREATE POLICY "team_members_select_member" ON "actors"."team_members" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "actors"."actors" "a"
  WHERE (("a"."id" = "team_members"."actor_id") AND ("a"."owner_lenser_id" = "lensers"."get_auth_lenser_id"())))));



CREATE POLICY "team_members_service_all" ON "actors"."team_members" TO "service_role" USING (true) WITH CHECK (true);
...
CREATE POLICY "teams_insert_own" ON "actors"."teams" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM "actors"."actors" "a"
  WHERE (("a"."id" = "teams"."owner_actor_id") AND ("a"."owner_lenser_id" = "lensers"."get_auth_lenser_id"())))));



CREATE POLICY "teams_select_own" ON "actors"."teams" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "actors"."actors" "a"
  WHERE (("a"."id" = "teams"."owner_actor_id") AND ("a"."owner_lenser_id" = "lensers"."get_auth_lenser_id"())))));



CREATE POLICY "teams_select_public" ON "actors"."teams" FOR SELECT TO "authenticated" USING (("visibility" = 'public'::"text"));



CREATE POLICY "teams_service_all" ON "actors"."teams" TO "service_role" USING (true) WITH CHECK (true);



CREATE POLICY "teams_update_own" ON "actors"."teams" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "actors"."actors" "a"
  WHERE (("a"."id" = "teams"."owner_actor_id") AND ("a"."owner_lenser_id" = "lensers"."get_auth_lenser_id"()))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "actors"."actors" "a"
  WHERE (("a"."id" = "teams"."owner_actor_id") AND ("a"."owner_lenser_id" = "lensers"."get_auth_lenser_id"())))));
...
CREATE POLICY "agent_adapters_delete_own" ON "agents"."agent_adapters" FOR DELETE TO "authenticated" USING (("owner_lenser_id" = "lensers"."get_auth_lenser_id"()));



CREATE POLICY "agent_adapters_insert_own" ON "agents"."agent_adapters" FOR INSERT TO "authenticated" WITH CHECK (("owner_lenser_id" = "lensers"."get_auth_lenser_id"()));



CREATE POLICY "agent_adapters_select_own" ON "agents"."agent_adapters" FOR SELECT TO "authenticated" USING (("owner_lenser_id" = "lensers"."get_auth_lenser_id"()));



CREATE POLICY "agent_adapters_service_all" ON "agents"."agent_adapters" TO "service_role" USING (true) WITH CHECK (true);



CREATE POLICY "agent_adapters_update_own" ON "agents"."agent_adapters" FOR UPDATE TO "authenticated" USING (("owner_lenser_id" = "lensers"."get_auth_lenser_id"())) WITH CHECK (("owner_lenser_id" = "lensers"."get_auth_lenser_id"()));
...
CREATE POLICY "agent_definitions_insert_own" ON "agents"."agent_definitions" FOR INSERT TO "authenticated" WITH CHECK (("owner_lenser_id" = "lensers"."get_auth_lenser_id"()));



CREATE POLICY "agent_definitions_select_own" ON "agents"."agent_definitions" FOR SELECT TO "authenticated" USING (("owner_lenser_id" = "lensers"."get_auth_lenser_id"()));



CREATE POLICY "agent_definitions_select_public" ON "agents"."agent_definitions" FOR SELECT TO "authenticated", "anon" USING ((("is_public" = true) AND ("is_active" = true)));



CREATE POLICY "agent_definitions_service_all" ON "agents"."agent_definitions" TO "service_role" USING (true) WITH CHECK (true);



CREATE POLICY "agent_definitions_update_own" ON "agents"."agent_definitions" FOR UPDATE TO "authenticated" USING (("owner_lenser_id" = "lensers"."get_auth_lenser_id"())) WITH CHECK (("owner_lenser_id" = "lensers"."get_auth_lenser_id"()));
...
CREATE POLICY "agent_instances_insert_own" ON "agents"."agent_instances" FOR INSERT TO "authenticated" WITH CHECK (("owner_lenser_id" = "lensers"."get_auth_lenser_id"()));



CREATE POLICY "agent_instances_select_own" ON "agents"."agent_instances" FOR SELECT TO "authenticated" USING (("owner_lenser_id" = "lensers"."get_auth_lenser_id"()));



CREATE POLICY "agent_instances_service_all" ON "agents"."agent_instances" TO "service_role" USING (true) WITH CHECK (true);



CREATE POLICY "agent_instances_update_own" ON "agents"."agent_instances" FOR UPDATE TO "authenticated" USING (("owner_lenser_id" = "lensers"."get_auth_lenser_id"())) WITH CHECK (("owner_lenser_id" = "lensers"."get_auth_lenser_id"()));
...
CREATE POLICY "agent_productivity_scopes_select_own" ON "agents"."agent_productivity_scopes" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "agents"."agent_definitions" "d"
  WHERE (("d"."id" = "agent_productivity_scopes"."definition_id") AND ("d"."owner_lenser_id" = "lensers"."get_auth_lenser_id"())))));



CREATE POLICY "agent_productivity_scopes_service_all" ON "agents"."agent_productivity_scopes" TO "service_role" USING (true) WITH CHECK (true);
...
CREATE POLICY "agent_tool_allowlist_select_own" ON "agents"."agent_tool_allowlist" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "agents"."agent_definitions" "d"
  WHERE (("d"."id" = "agent_tool_allowlist"."definition_id") AND ("d"."owner_lenser_id" = "lensers"."get_auth_lenser_id"())))));



CREATE POLICY "agent_tool_allowlist_service_all" ON "agents"."agent_tool_allowlist" TO "service_role" USING (true) WITH CHECK (true);
...
CREATE POLICY "agent_versions_select_own" ON "agents"."agent_versions" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "agents"."agent_definitions" "d"
  WHERE (("d"."id" = "agent_versions"."definition_id") AND ("d"."owner_lenser_id" = "lensers"."get_auth_lenser_id"())))));



CREATE POLICY "agent_versions_select_public" ON "agents"."agent_versions" FOR SELECT TO "authenticated", "anon" USING ((EXISTS ( SELECT 1
   FROM "agents"."agent_definitions" "d"
  WHERE (("d"."id" = "agent_versions"."definition_id") AND ("d"."is_public" = true)))));



CREATE POLICY "agent_versions_service_all" ON "agents"."agent_versions" TO "service_role" USING (true) WITH CHECK (true);
...
CREATE POLICY "byok_key_refs_insert_own" ON "agents"."byok_key_refs" FOR INSERT TO "authenticated" WITH CHECK (("owner_lenser_id" = "lensers"."get_auth_lenser_id"()));



CREATE POLICY "byok_key_refs_select_own" ON "agents"."byok_key_refs" FOR SELECT TO "authenticated" USING (("owner_lenser_id" = "lensers"."get_auth_lenser_id"()));



CREATE POLICY "byok_key_refs_service_all" ON "agents"."byok_key_refs" TO "service_role" USING (true) WITH CHECK (true);



CREATE POLICY "byok_key_refs_update_own" ON "agents"."byok_key_refs" FOR UPDATE TO "authenticated" USING (("owner_lenser_id" = "lensers"."get_auth_lenser_id"())) WITH CHECK (("owner_lenser_id" = "lensers"."get_auth_lenser_id"()));
...
CREATE POLICY "local_runtime_profiles_insert_own" ON "agents"."local_runtime_profiles" FOR INSERT TO "authenticated" WITH CHECK (("owner_lenser_id" = "lensers"."get_auth_lenser_id"()));



CREATE POLICY "local_runtime_profiles_select_own" ON "agents"."local_runtime_profiles" FOR SELECT TO "authenticated" USING (("owner_lenser_id" = "lensers"."get_auth_lenser_id"()));



CREATE POLICY "local_runtime_profiles_service_all" ON "agents"."local_runtime_profiles" TO "service_role" USING (true) WITH CHECK (true);



CREATE POLICY "local_runtime_profiles_update_own" ON "agents"."local_runtime_profiles" FOR UPDATE TO "authenticated" USING (("owner_lenser_id" = "lensers"."get_auth_lenser_id"())) WITH CHECK (("owner_lenser_id" = "lensers"."get_auth_lenser_id"()));
...
CREATE POLICY "tools_select_active" ON "agents"."tools" FOR SELECT TO "authenticated", "anon" USING (("is_active" = true));



CREATE POLICY "tools_service_all" ON "agents"."tools" TO "service_role" USING (true) WITH CHECK (true);
...
CREATE POLICY "ai_models_select_public_anon" ON "ai"."models" FOR SELECT TO "anon" USING (("is_public" = true));
...
CREATE POLICY "feature_policies_select_active" ON "ai"."feature_model_policies" FOR SELECT TO "authenticated", "anon" USING (("is_active" = true));



CREATE POLICY "feature_policies_service_all" ON "ai"."feature_model_policies" TO "service_role" USING (true) WITH CHECK (true);



CREATE POLICY "margin_policies_service_all" ON "ai"."execution_margin_policies" TO "service_role" USING (true) WITH CHECK (true);
...
CREATE POLICY "providers_select_active" ON "ai"."providers" FOR SELECT TO "authenticated", "anon" USING (("is_active" = true));
...
CREATE POLICY "admin_actions_service_all" ON "audit"."admin_actions" TO "service_role" USING (true) WITH CHECK (true);
...
CREATE POLICY "events_select_own" ON "audit"."events" FOR SELECT TO "authenticated" USING (("actor_lenser_id" = "lensers"."get_auth_lenser_id"()));



CREATE POLICY "events_service_insert" ON "audit"."events" FOR INSERT TO "service_role" WITH CHECK (true);



CREATE POLICY "events_service_select" ON "audit"."events" FOR SELECT TO "service_role" USING (true);



CREATE POLICY "mod_decisions_service_all" ON "audit"."moderation_decisions" TO "service_role" USING (true) WITH CHECK (true);
...
CREATE POLICY "security_events_select_own" ON "audit"."security_events" FOR SELECT TO "authenticated" USING (("lenser_id" = "lensers"."get_auth_lenser_id"()));



CREATE POLICY "security_events_service_all" ON "audit"."security_events" TO "service_role" USING (true) WITH CHECK (true);
...
CREATE POLICY "battles_select" ON "battles"."battles" FOR SELECT USING (((("status" = ANY (ARRAY['voting'::"battles"."battle_status_enum", 'scoring'::"battles"."battle_status_enum", 'closed'::"battles"."battle_status_enum", 'published'::"battles"."battle_status_enum"])) AND ("deleted_at" IS NULL)) OR ("creator_lenser_id" = "lensers"."get_auth_lenser_id"())));
...
CREATE POLICY "contenders_select" ON "battles"."contenders" FOR SELECT USING (((EXISTS ( SELECT 1
   FROM "battles"."battles" "b"
  WHERE (("b"."id" = "contenders"."battle_id") AND ("b"."status" = ANY (ARRAY['voting'::"battles"."battle_status_enum", 'scoring'::"battles"."battle_status_enum", 'closed'::"battles"."battle_status_enum", 'published'::"battles"."battle_status_enum"])) AND ("b"."deleted_at" IS NULL)))) OR (EXISTS ( SELECT 1
   FROM "battles"."battles" "b"
  WHERE (("b"."id" = "contenders"."battle_id") AND ("b"."creator_lenser_id" = "lensers"."get_auth_lenser_id"())))) OR (("contender_type" = 'human'::"battles"."contender_type_enum") AND ("contender_ref_id" = ( SELECT "profiles"."id"
   FROM "lensers"."profiles"
...
CREATE POLICY "events_select" ON "battles"."events" FOR SELECT USING (((( SELECT "auth"."role"() AS "role") = 'service_role'::"text") OR (EXISTS ( SELECT 1
   FROM "battles"."battles" "b"
  WHERE (("b"."id" = "events"."battle_id") AND ("b"."creator_lenser_id" = "lensers"."get_auth_lenser_id"()))))));



CREATE POLICY "events_service_delete" ON "battles"."events" FOR DELETE USING ((( SELECT "auth"."role"() AS "role") = 'service_role'::"text"));



CREATE POLICY "events_service_update" ON "battles"."events" FOR UPDATE USING ((( SELECT "auth"."role"() AS "role") = 'service_role'::"text")) WITH CHECK ((( SELECT "auth"."role"() AS "role") = 'service_role'::"text"));



CREATE POLICY "events_service_write" ON "battles"."events" FOR INSERT WITH CHECK ((( SELECT "auth"."role"() AS "role") = 'service_role'::"text"));
...
CREATE POLICY "invitations_select" ON "battles"."invitations" FOR SELECT TO "authenticated" USING ((("invited_lenser_id" = "lensers"."get_auth_lenser_id"()) OR ("invited_by" = "lensers"."get_auth_lenser_id"())));
...
CREATE POLICY "rubric_criteria_select" ON "battles"."rubric_criteria" FOR SELECT USING (((EXISTS ( SELECT 1
   FROM "battles"."rubrics" "r"
  WHERE (("r"."id" = "rubric_criteria"."rubric_id") AND ("r"."is_public" = true) AND ("r"."deleted_at" IS NULL)))) OR (EXISTS ( SELECT 1
   FROM "battles"."rubrics" "r"
  WHERE (("r"."id" = "rubric_criteria"."rubric_id") AND ("r"."creator_lenser_id" = "lensers"."get_auth_lenser_id"()))))));
...
CREATE POLICY "rubrics_select" ON "battles"."rubrics" FOR SELECT USING (((("is_public" = true) AND ("deleted_at" IS NULL)) OR ("creator_lenser_id" = "lensers"."get_auth_lenser_id"())));
...
CREATE POLICY "submissions_select" ON "battles"."submissions" FOR SELECT USING (((EXISTS ( SELECT 1
   FROM "battles"."battles" "b"
  WHERE (("b"."id" = "submissions"."battle_id") AND ("b"."status" = ANY (ARRAY['voting'::"battles"."battle_status_enum", 'scoring'::"battles"."battle_status_enum", 'closed'::"battles"."battle_status_enum", 'published'::"battles"."battle_status_enum"])) AND ("b"."deleted_at" IS NULL)))) OR (EXISTS ( SELECT 1
   FROM "battles"."battles" "b"
  WHERE (("b"."id" = "submissions"."battle_id") AND ("b"."creator_lenser_id" = "lensers"."get_auth_lenser_id"())))) OR (EXISTS ( SELECT 1
   FROM "battles"."contenders" "c"
...
CREATE POLICY "templates_select" ON "battles"."templates" FOR SELECT USING (((("is_public" = true) AND ("deleted_at" IS NULL)) OR ("creator_lenser_id" = "lensers"."get_auth_lenser_id"())));
...
CREATE POLICY "vote_aggregates_select_public" ON "battles"."vote_aggregates" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "battles"."battles" "b"
  WHERE (("b"."id" = "vote_aggregates"."battle_id") AND ("b"."status" = ANY (ARRAY['voting'::"battles"."battle_status_enum", 'scoring'::"battles"."battle_status_enum", 'closed'::"battles"."battle_status_enum", 'published'::"battles"."battle_status_enum"])) AND ("b"."deleted_at" IS NULL)))));



CREATE POLICY "vote_aggregates_service_all" ON "battles"."vote_aggregates" TO "service_role" USING (true) WITH CHECK (true);
...
CREATE POLICY "vote_choices_select_public" ON "battles"."vote_choices" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM ("battles"."votes" "v"
     JOIN "battles"."battles" "b" ON (("b"."id" = "v"."battle_id")))
  WHERE (("v"."id" = "vote_choices"."vote_id") AND ("b"."status" = ANY (ARRAY['voting'::"battles"."battle_status_enum", 'scoring'::"battles"."battle_status_enum", 'closed'::"battles"."battle_status_enum", 'published'::"battles"."battle_status_enum"])) AND ("b"."deleted_at" IS NULL)))));



CREATE POLICY "vote_choices_service_all" ON "battles"."vote_choices" TO "service_role" USING (true) WITH CHECK (true);
...
CREATE POLICY "media_library_delete" ON "content"."media_library" FOR DELETE TO "authenticated" USING ("lensers"."user_owns_lenser"("lenser_id"));



CREATE POLICY "media_library_insert" ON "content"."media_library" FOR INSERT TO "authenticated" WITH CHECK ("lensers"."user_owns_lenser"("lenser_id"));



CREATE POLICY "media_library_select" ON "content"."media_library" FOR SELECT TO "authenticated" USING (("lensers"."user_owns_lenser"("lenser_id") OR "public"."is_admin"()));



CREATE POLICY "media_library_update" ON "content"."media_library" FOR UPDATE TO "authenticated" USING ("lensers"."user_owns_lenser"("lenser_id")) WITH CHECK ("lensers"."user_owns_lenser"("lenser_id"));
...
CREATE POLICY "prompt_templates_select" ON "content"."prompt_templates" FOR SELECT USING (((("visibility" = ANY (ARRAY['public'::"content"."visibility_enum", 'community'::"content"."visibility_enum"])) AND ("status" = 'published'::"content"."content_status")) OR ("lenser_id" = "lensers"."get_auth_lenser_id"())));
...
CREATE POLICY "tag_map_author_delete" ON "content"."tag_map" FOR DELETE TO "authenticated" USING (((("entity_type" = 'prompt_template'::"content"."entity_type_enum") AND (EXISTS ( SELECT 1
   FROM "content"."prompt_templates" "p"
...
CREATE POLICY "tag_map_author_manage" ON "content"."tag_map" FOR INSERT TO "authenticated" WITH CHECK (((("entity_type" = 'prompt_template'::"content"."entity_type_enum") AND (EXISTS ( SELECT 1
   FROM "content"."prompt_templates" "p"
  WHERE (("p"."id" = "tag_map"."entity_id") AND ("p"."lenser_id" = "lensers"."get_auth_lenser_id"()))))) OR (("entity_type" = 'thread'::"content"."entity_type_enum") AND (EXISTS ( SELECT 1
   FROM "content"."threads" "t"
  WHERE (("t"."id" = "tag_map"."entity_id") AND ("t"."lenser_id" = "lensers"."get_auth_lenser_id"())))))));
...
CREATE POLICY "threads_select" ON "content"."threads" FOR SELECT USING (((("visibility" = ANY (ARRAY['public'::"content"."visibility_enum", 'community'::"content"."visibility_enum"])) AND ("status" = 'published'::"content"."content_status")) OR ("lensers"."is_active_lenser"(( SELECT "auth"."uid"() AS "uid")) AND ("lenser_id" = "lensers"."current_active_lenser_id"()))));
...
CREATE POLICY "artifacts_select_own" ON "execution"."artifacts" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM ("execution"."runs" "ru"
     JOIN "execution"."requests" "rq" ON (("rq"."id" = "ru"."request_id")))
  WHERE (("ru"."id" = "artifacts"."run_id") AND ("rq"."requester_lenser_id" = "lensers"."get_auth_lenser_id"())))));



CREATE POLICY "artifacts_select_public" ON "execution"."artifacts" FOR SELECT TO "authenticated" USING (("visibility" = 'public'::"text"));
...
CREATE POLICY "links_select_own" ON "execution"."links" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM ("execution"."runs" "ru"
     JOIN "execution"."requests" "rq" ON (("rq"."id" = "ru"."request_id")))
  WHERE (("ru"."id" = "links"."run_id") AND ("rq"."requester_lenser_id" = "lensers"."get_auth_lenser_id"())))));



CREATE POLICY "links_service_all" ON "execution"."links" TO "service_role" USING (true) WITH CHECK (true);
...
CREATE POLICY "badges_service_write" ON "lensers"."badges" USING ((( SELECT "auth"."role"() AS "role") = 'service_role'::"text")) WITH CHECK ((( SELECT "auth"."role"() AS "role") = 'service_role'::"text"));
...
CREATE POLICY "profiles_select" ON "lensers"."profiles" FOR SELECT USING ((("user_id" = "auth"."uid"()) OR (("status" = 'active'::"lensers"."lenser_status") AND ("deletion_requested_at" IS NULL) AND ("visibility" = ANY (ARRAY['public'::"lensers"."lenser_visibility", 'community'::"lensers"."lenser_visibility"]))) OR (("status" = 'active'::"lensers"."lenser_status") AND ("deletion_requested_at" IS NULL) AND ("visibility" = 'private'::"lensers"."lenser_visibility") AND ("auth"."uid"() IS NOT NULL))));



CREATE POLICY "profiles_service_update" ON "lensers"."profiles" FOR UPDATE USING ((( SELECT "auth"."role"() AS "role") = 'service_role'::"text")) WITH CHECK ((( SELECT "auth"."role"() AS "role") = 'service_role'::"text"));
...
CREATE POLICY "relationships_select" ON "lensers"."relationships" FOR SELECT USING ((("source_profile_id" IN ( SELECT "profiles"."id"
   FROM "lensers"."profiles"
  WHERE ("profiles"."user_id" = "auth"."uid"()))) OR ("target_profile_id" IN ( SELECT "profiles"."id"
   FROM "lensers"."profiles"
...
CREATE POLICY "contact_select" ON "ops"."contact" FOR SELECT USING (((( SELECT "auth"."role"() AS "role") = 'service_role'::"text") OR (( SELECT "auth"."role"() AS "role") = 'admin'::"text") OR (("lenser_id" IS NOT NULL) AND (( SELECT "l"."user_id"
   FROM "lensers"."profiles" "l"
...
CREATE POLICY "xp_apps_manage_service" ON "xp"."apps" TO "service_role" USING (true) WITH CHECK (true);



CREATE POLICY "xp_apps_select_public" ON "xp"."apps" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "xp_contributions_manage_service" ON "xp"."contributions" TO "service_role" USING (true) WITH CHECK (true);



CREATE POLICY "xp_contributions_select_own" ON "xp"."contributions" FOR SELECT TO "authenticated" USING (("lenser_id" = "auth"."uid"()));



CREATE POLICY "xp_difficulty_multipliers_manage_service" ON "xp"."difficulty_multipliers" TO "service_role" USING (true) WITH CHECK (true);



CREATE POLICY "xp_difficulty_multipliers_select_public" ON "xp"."difficulty_multipliers" FOR SELECT TO "authenticated" USING (true);
...
CREATE POLICY "xp_levels_service_delete" ON "xp"."levels" FOR DELETE USING ((( SELECT "auth"."role"() AS "role") = 'service_role'::"text"));



CREATE POLICY "xp_levels_service_update" ON "xp"."levels" FOR UPDATE USING ((( SELECT "auth"."role"() AS "role") = 'service_role'::"text")) WITH CHECK ((( SELECT "auth"."role"() AS "role") = 'service_role'::"text"));



CREATE POLICY "xp_levels_service_write" ON "xp"."levels" FOR INSERT WITH CHECK ((( SELECT "auth"."role"() AS "role") = 'service_role'::"text"));
...
GRANT ALL ON FUNCTION "audit"."log_event"("p_event_type" "text", "p_entity_schema" "text", "p_entity_table" "text", "p_entity_id" "uuid", "p_actor_lenser_id" "uuid", "p_actor_actor_id" "uuid", "p_payload" "jsonb", "p_severity" "text") TO "service_role";
GRANT ALL ON FUNCTION "audit"."log_event"("p_event_type" "text", "p_entity_schema" "text", "p_entity_table" "text", "p_entity_id" "uuid", "p_actor_lenser_id" "uuid", "p_actor_actor_id" "uuid", "p_payload" "jsonb", "p_severity" "text") TO "authenticated";
...
GRANT ALL ON FUNCTION "battles"."fn_auto_finalize_battles"() TO "service_role";
...
GRANT ALL ON FUNCTION "battles"."trg_submissions_validate_execution_link"() TO "service_role";
...
GRANT ALL ON FUNCTION "xp"."auto_create_next_season"("p_app_id" "uuid", "p_duration_days" integer) TO "service_role";



GRANT ALL ON FUNCTION "xp"."check_all_seasons"() TO "service_role";
...
GRANT ALL ON FUNCTION "xp"."grant_contribution_xp"("p_lenser_id" "uuid", "p_context" "xp"."contribution_context_enum", "p_contribution_type" "text", "p_external_ref" "text", "p_title" "text", "p_metadata" "jsonb") TO "service_role";
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "agents"."agent_adapters" TO "authenticated";
...
GRANT SELECT ON TABLE "agents"."byok_key_refs_safe" TO "anon";
GRANT SELECT ON TABLE "agents"."byok_key_refs_safe" TO "authenticated";
GRANT ALL ON TABLE "agents"."byok_key_refs_safe" TO "service_role";
...
GRANT SELECT ON TABLE "agents"."tools" TO "anon";
GRANT SELECT ON TABLE "agents"."tools" TO "authenticated";
...
GRANT SELECT ON TABLE "ai"."feature_model_policies" TO "anon";
GRANT SELECT ON TABLE "ai"."feature_model_policies" TO "authenticated";
...
GRANT SELECT ON TABLE "ai"."providers" TO "anon";
GRANT SELECT ON TABLE "ai"."providers" TO "authenticated";
...
GRANT SELECT ON TABLE "battles"."vote_aggregates" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "battles"."vote_aggregates" TO "authenticated";
GRANT ALL ON TABLE "battles"."vote_aggregates" TO "service_role";



GRANT SELECT ON TABLE "battles"."vote_choices" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "battles"."vote_choices" TO "authenticated";
...
GRANT SELECT ON TABLE "xp"."contributions" TO "authenticated";
GRANT ALL ON TABLE "xp"."contributions" TO "service_role";



GRANT SELECT ON TABLE "xp"."difficulty_multipliers" TO "authenticated";
GRANT ALL ON TABLE "xp"."difficulty_multipliers" TO "service_role";
