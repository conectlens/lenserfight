...
CREATE OR REPLACE FUNCTION "public"."fn_content_get_personal_prompts"("p_lenser_id" "uuid", "p_limit" integer DEFAULT 20, "p_offset" integer DEFAULT 0) RETURNS TABLE("id" "uuid", "personal_score" double precision, "hot_score" double precision, "primary_language" "text", "author_profile" "jsonb", "tags" "jsonb", "reaction_totals" "jsonb", "title" "text", "description" "text", "created_at" timestamp with time zone)
    LANGUAGE "sql" STABLE
...
ALTER FUNCTION "public"."fn_content_get_personal_prompts"("p_lenser_id" "uuid", "p_limit" integer, "p_offset" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."fn_content_get_personal_threads"("p_lenser_id" "uuid", "p_limit" integer DEFAULT 20, "p_offset" integer DEFAULT 0) RETURNS TABLE("id" "uuid", "personal_score" double precision, "hot_score" double precision, "primary_language" "text", "author_profile" "jsonb", "tags" "jsonb", "reaction_totals" "jsonb", "title" "text", "reply_count" integer, "created_at" timestamp with time zone)
    LANGUAGE "sql" STABLE
    SET "search_path" TO 'public', 'content', 'lensers'
    AS $$
WITH
...
ALTER FUNCTION "public"."fn_content_get_personal_threads"("p_lenser_id" "uuid", "p_limit" integer, "p_offset" integer) OWNER TO "postgres";
...
CREATE OR REPLACE VIEW "public"."vw_battle_health" AS
 SELECT "b"."id",
    ...
    ( SELECT "count"(*) AS "count"
           FROM "battles"."contenders" "c"
          WHERE ("c"."battle_id" = "b"."id")) AS "contender_count",
    ( SELECT "count"(*) AS "count"
           FROM "battles"."submissions" "s"
          WHERE (("s"."battle_id" = "b"."id") AND ("s"."status" = 'submitted'::"battles"."submission_status_enum"))) AS "submission_count",
        CASE
...
CREATE POLICY "Service role has full access to events" ON "battles"."events" USING (("auth"."role"() = 'service_role'::"text")) WITH CHECK (("auth"."role"() = 'service_role'::"text"));
...
CREATE POLICY "profiles_owner_update" ON "lensers"."profiles" FOR UPDATE TO "authenticated" USING (("user_id" = "auth"."uid"())) WITH CHECK (("user_id" = "auth"."uid"()));
...
REVOKE ALL ON FUNCTION "public"."fn_content_get_personal_prompts"("p_lenser_id" "uuid", "p_limit" integer, "p_offset" integer) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."fn_content_get_personal_prompts"("p_lenser_id" "uuid", "p_limit" integer, "p_offset" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."fn_content_get_personal_prompts"("p_lenser_id" "uuid", "p_limit" integer, "p_offset" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."fn_content_get_personal_prompts"("p_lenser_id" "uuid", "p_limit" integer, "p_offset" integer) TO "service_role";



REVOKE ALL ON FUNCTION "public"."fn_content_get_personal_threads"("p_lenser_id" "uuid", "p_limit" integer, "p_offset" integer) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."fn_content_get_personal_threads"("p_lenser_id" "uuid", "p_limit" integer, "p_offset" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."fn_content_get_personal_threads"("p_lenser_id" "uuid", "p_limit" integer, "p_offset" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."fn_content_get_personal_threads"("p_lenser_id" "uuid", "p_limit" integer, "p_offset" integer) TO "service_role";
