...
CREATE POLICY "ai_generations_select" ON "ai"."generations" FOR SELECT TO "authenticated" USING ((("lenser_id" = "lensers"."get_auth_lenser_id"()) OR (((( SELECT "auth"."jwt"() AS "jwt") ->> 'is_super_admin'::"text"))::boolean = true)));
