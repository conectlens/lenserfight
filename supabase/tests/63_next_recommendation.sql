...
VALUES
  ('11111111-bx01-1111-1111-111111111111', 'bx-creator@test.local'),
  ('22222222-bx01-2222-2222-222222222222', 'bx-cont-b@test.local'),
  ('33333333-bx01-3333-3333-333333333333', 'bx-voter@test.local')
ON CONFLICT (id) DO NOTHING;

INSERT INTO lensers.profiles (id, user_id, handle, display_name, type)
VALUES
  ('11111111-bx01-1111-1111-111111111111',
   '11111111-bx01-1111-1111-111111111111', 'bx_creator', 'BX Creator', 'human'),
  ('22222222-bx01-2222-2222-222222222222',
   '22222222-bx01-2222-2222-222222222222', 'bx_cont_b', 'BX Contender B', 'human'),
  ('33333333-bx01-3333-3333-333333333333',
   '33333333-bx01-3333-3333-333333333333', 'bx_voter', 'BX Voter', 'human')
ON CONFLICT (id) DO NOTHING;

INSERT INTO battles.templates (id, creator_lenser_id, title, task_prompt, is_public, category)
VALUES ('aaaa01aa-bx01-aaaa-aaaa-aaaaaaaaaaaa',
        '11111111-bx01-1111-1111-111111111111',
...
INSERT INTO battles.battles (
  ...
  'bbbb01bb-bx01-bbbb-bbbb-bbbbbbbbbbbb',
  '11111111-bx01-1111-1111-111111111111',
  'BX Battle', 'bx-battle', 'task', 'closed',
  2, 'aaaa01aa-bx01-aaaa-aaaa-aaaaaaaaaaaa', now()
) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO battles.contenders (
  ...
  ('cccc01cc-bx01-cccc-cccc-aaaaaaaaaaaa',
   'bbbb01bb-bx01-bbbb-bbbb-bbbbbbbbbbbb', 'A',
   'human'::battles.contender_type_enum,
   '11111111-bx01-1111-1111-111111111111', 'A', 'accepted'),
  ('cccc01cc-bx01-cccc-cccc-bbbbbbbbbbbb',
   'bbbb01bb-bx01-bbbb-bbbb-bbbbbbbbbbbb', 'B',
   'human'::battles.contender_type_enum,
   '22222222-bx01-2222-2222-222222222222', 'B', 'accepted')
ON CONFLICT (id) DO NOTHING;
...
SET LOCAL "request.jwt.claims" TO
  '{"sub":"22222222-bx01-2222-2222-222222222222","role":"authenticated"}';
SET LOCAL ROLE authenticated;

SELECT is(
  public.fn_battles_next_recommendation(
    'bbbb01bb-bx01-bbbb-bbbb-bbbbbbbbbbbb'::uuid
  )->>'action',
  'rematch',
...
RESET ROLE;
SET LOCAL "request.jwt.claims" TO
  '{"sub":"33333333-bx01-3333-3333-333333333333","role":"authenticated"}';
SET LOCAL ROLE authenticated;
