...
UNION ALL SELECT 'lenses.lenses', count(*) FROM lenses.lenses
UNION ALL SELECT 'content.tags', count(*) FROM content.tags
UNION ALL SELECT 'content.tag_map', count(*) FROM content.tag_map
UNION ALL SELECT 'content.entity_translations', count(*) FROM content.entity_translations
UNION ALL SELECT 'content.thread_replies', count(*) FROM content.thread_replies
UNION ALL SELECT 'content.reactions', count(*) FROM content.reactions
UNION ALL SELECT 'lensers.relationships', count(*) FROM lensers.relationships
...
--
-- ============================================================
-- BENCHMARK 2: vw_hot_scores (top 50)
-- ============================================================

EXPLAIN (FORMAT TEXT)
SELECT * FROM lenses.vw_hot_scores
ORDER BY hot_score DESC LIMIT 50;
...
WHERE et.entity_type = 'thread'::"content"."entity_type_enum"
  AND et.is_original = true
GROUP BY et.language_code
...
SELECT entity_type::text AS source, reaction::text, count(*) AS cnt
FROM content.reactions
GROUP BY entity_type, reaction
