...
export const BattleListScreen: React.FC = () => {
...
export const BattleDetailScreen: React.FC<{ id: string }> = ({ id }) => {
  const { t } = useTranslation()
            ...
            <DetailSection title={battle.title}>
              ...
              {battle.scheduledStart && (
                <Text variant="caption" color="muted">
                  {t('battles.timeLeft')}:{' '}
                  {new Date(battle.scheduledEnd ?? battle.scheduledStart).toLocaleDateString()}
                </Text>
              )}
            </DetailSection>
