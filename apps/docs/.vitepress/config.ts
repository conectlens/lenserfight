...
const EN_REFERENCE_WORKFLOWS_SIDEBAR = [
  {
    ...
    items: [
      ...
      { text: 'Import Protocol', link: '/en/reference/workflows/workflow-import-protocol' },
    ...
    items: [
      ...
      { text: 'MCP Tool Reference', link: '/en/reference/mcp' },
      {
        ...
        items: [
          ...
          { text: 'Agent Tools', link: '/en/reference/mcp-server/tools-agent' },
          {
            ...
            items: [
              ...
              { text: 'All 43 Tools', link: '/en/reference/mcp-server/provider-tools' },
            ],
          },
        ],
      },
...
export default defineConfig({
  ...
  sitemap: {
    ...
    transformItems(items) {
      return items.map((item) => {
        ...
        if (url === '' || url === '/en/' || url.match(/^\/en\/?$/)) {
          priority = 1.0
          changefreq = 'daily'
        } else if (url.includes('/tutorials/getting-started/')) {
          priority = 0.95
          ...
          priority = 0.85
          changefreq = 'monthly'
        } else if (url.includes('/how-to/')) {
          priority = 0.8
        } else if (url.includes('/explanation/')) {
          priority = 0.7
          changefreq = 'monthly'
  ...
  buildEnd: async (siteConfig) => {
    ...
    // llms.txt — AI-readable site manifest (https://llmstxt.org/)
    writeFileSync(join(outDir, 'llms.txt'), generateLlmsTxt(), 'utf-8')

    // feed.xml — RSS for changelog
    writeFileSync(join(outDir, 'feed.xml'), generateChangelogRss(new Date()), 'utf-8')
  },
          ...
          '/tr/reference/mcp-server/': [
            ...
            },
            {
              ...
              items: [
                ...
                { text: '43 Aracın Tümü', link: '/tr/reference/mcp-server/provider-tools' },
              ],
            },
          ],
          '/tr/reference/cli/': [
          ...
          '/tr/explanation/': [
            ...
            },
            {
              ...
              items: [
                ...
                { text: 'Hukuki Politikalar', link: '/tr/explanation/community/legal-policies' },
              ],
            },
            {
              text: 'Savaşlar',
      ...
      '/en/how-to/workflows/': [
        {
          ...
          items: [
            ...
            { text: 'Import a Workflow', link: '/en/how-to/workflows/import-a-workflow' },
          ],
        },
      ],
      ...
      '/en/explanation/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Legal Policies', link: '/en/explanation/community/legal-policies' },
