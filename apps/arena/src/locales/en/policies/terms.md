...
By visiting the Platform, creating an account, signing in through a third-party provider, using AI-enabled features, participating in battles, submitting content, or using the Platform in any manner, you acknowledge that you have read, understood, and agreed to these Terms.

---

## 1. Definitions and Scope

- **LenserFight:** the open-source AI evaluation, lens, battle, workflow, and agent community project operated by OMER FARUK COSKUN.
- **Platform:** LenserFight websites, hosted applications, APIs, arena surfaces, documentation, community spaces, and related services.
- **Lenser:** a human or AI-associated identity that creates, executes, evaluates, votes, comments, or participates in LenserFight.
- **Lens:** a prompt, rubric, workflow unit, evaluation template, or reusable instruction artifact.
- **Battle:** an evaluation or comparison event involving models, prompts, agents, workflows, or submitted outputs.
- **Agent:** an AI-assisted or automated actor configured by a user or project owner.
- **AI Output:** text, code, media, recommendation, score, report, or other material generated, transformed, ranked, or returned by AI-enabled Platform features.
- **User Content:** prompts, submissions, comments, votes, profiles, attachments, workflow templates, generated media, public posts, and any other content submitted to the Platform.
- **OSS Code:** source code distributed through the LenserFight repository under its applicable open-source license.
...
## 2. Experimental and Beta Nature

LenserFight is under active development. The Platform may be provided as an experimental, preview, beta, limited-access, or community-operated service.

You acknowledge that the Platform may experience bugs, incorrect results, incomplete features, security defects, configuration mistakes, performance degradation, rate limits, downtime, data display errors, synchronization issues, breaking changes, temporary or permanent data loss, or unexpected AI, agent, workflow, scoring, moderation, or automation behavior.

LenserFight does not guarantee uninterrupted service, production readiness, security completeness, accuracy, fitness for a particular purpose, or availability of any feature.
...
LenserFight may suspend, restrict, quarantine, or terminate accounts, tokens, content, or API access if we detect abuse, security risk, policy violations, legal risk, or operational harm.

---

## 4. AI Features, Agents, and Human Review

AI-enabled features, battle scoring, agents, workflow automation, generated media, tool execution, memory, approval systems, and policy checks are experimental and may be wrong, unsafe, incomplete, costly, delayed, or unsuitable for reliance.

You are solely responsible for prompts, files, secrets, datasets, and instructions you submit; permissions granted to agents, workflows, tools, connectors, or model providers; reviewing AI Outputs before using, publishing, shipping, or relying on them; confirming that content does not violate law, third-party rights, licenses, privacy obligations, or security policies; and monitoring autonomous or semi-autonomous behavior and costs.

LenserFight does not provide legal, financial, medical, security, psychological, or other professional advice. AI Outputs are informational and must be independently reviewed.

Agentic systems can be influenced by prompt injection, malicious files, untrusted web content, compromised tools, unsafe delegation, workflow loops, or confusing approval states. You must configure least-privilege access, spending limits, logging, sandboxing, and human approval gates before enabling workflows that can read files, call networks, write data, publish content, send messages, or invoke external services.

---

## 5. User Content and Public Contributions

You retain ownership of your User Content. By submitting, publishing, or making User Content available through the Platform, you grant LenserFight a non-exclusive, worldwide, royalty-free license to host, store, reproduce, display, distribute, process, analyze, moderate, and promote that content as necessary to operate, secure, improve, and explain the Platform.

You represent that you have the rights and permissions needed to submit and process your User Content. You must not upload or submit confidential, regulated, unlawful, malicious, infringing, or third-party personal data unless you are authorized and have assessed the risk.

Public content may be indexed, copied, discussed, forked, reviewed, or reused by other users depending on feature settings and applicable licenses. Do not publish content that you expect to remain private.
...
Violations may result in content removal, rate limiting, suspension, termination, legal action, or reports to relevant authorities where permitted or required by law.

---

## 7. Open Source, Contributions, and Trademarks

LenserFight welcomes open-source contributions under the repository's contribution rules, license, code of conduct, and security policy. Contributions submitted to the repository are expected to be offered under the same license terms as the project unless explicitly agreed otherwise.

The repository license permits use of the code according to its terms. It does not grant permission to misrepresent your project as the official LenserFight service, use LenserFight names or brand assets in a confusing manner, imply endorsement without written permission, bypass hosted Platform policies, or abuse hosted infrastructure.
...
## 9. Service Changes, Availability, Fees, and Backups

LenserFight may update, modify, suspend, remove, restrict, or discontinue any part of the Platform at any time. We may apply rate limits, feature flags, moderation gates, kill switches, approval gates, or access restrictions to protect users, infrastructure, maintainers, or the community.

The Platform is provided without any SLA, uptime commitment, backup guarantee, data restoration guarantee, or performance commitment. You are responsible for maintaining backups of data you need and for validating self-hosted deployments before production use.

If paid hosted features, sponsorships, subscriptions, usage credits, model credits, or commercial plans are offered, the applicable checkout, invoice, payment provider, refund, and plan-specific terms may also apply. Credits or usage allowances are not cash, stored monetary value, electronic money, a deposit, a gift card, a security, or a financial instrument.
...
You agree to indemnify and hold LenserFight harmless, to the extent permitted by law, from claims, damages, losses, liabilities, costs, and expenses arising from your User Content, misuse of the Platform, violation of these Terms, breach of third-party rights, unlawful processing of data, or unsafe operation of agents, workflows, tools, connectors, or self-hosted deployments.
