...
- **OSS Kodu:** LenserFight deposu üzerinden uygulanabilir açık kaynak lisansı kapsamında dağıtılan kaynak kod.
...
## 2. Deneysel ve Beta Niteliği

LenserFight aktif geliştirme altındadır. Platform deneysel, önizleme, beta, sınırlı erişimli veya topluluk tarafından işletilen hizmet olarak sunulabilir.

Platformda yazılım hataları, yanlış sonuçlar, eksik özellikler, güvenlik açıkları, yapılandırma hataları, performans düşüşü, oran sınırları, kesinti, veri görüntüleme hataları, senkronizasyon sorunları, kırıcı güncellemeler, geçici veya kalıcı veri kaybı ya da beklenmeyen AI, agent, iş akışı, puanlama, moderasyon veya otomasyon davranışı oluşabileceğini kabul edersiniz.

LenserFight kesintisiz hizmet, üretime hazır olma, güvenlik bütünlüğü, doğruluk, belirli bir amaca uygunluk veya herhangi bir özelliğin erişilebilirliği konusunda garanti vermez.
...
LenserFight hukuki, finansal, tıbbi, güvenlik, psikolojik veya başka bir profesyonel danışmanlık sağlamaz. AI Çıktıları bilgilendirme amaçlıdır ve bağımsız inceleme gerektirir.

Agentic sistemler prompt injection, kötü amaçlı dosyalar, güvenilmeyen web içeriği, ele geçirilmiş araçlar, güvensiz delegasyon, iş akışı döngüleri veya karışık onay durumlarından etkilenebilir. Dosya okuyan, ağ çağrısı yapan, veri yazan, içerik yayımlayan, mesaj gönderen veya harici servisleri çağıran iş akışlarını etkinleştirmeden önce en az yetki, harcama sınırları, loglama, sandboxing ve insan onayı kapılarını yapılandırmalısınız.

---

## 5. Kullanıcı İçeriği ve Herkese Açık Katkılar

Kullanıcı İçeriğiniz üzerindeki mülkiyet sizde kalır. Platforma Kullanıcı İçeriği göndererek, yayımlayarak veya kullanıma sunarak LenserFight'a bu içeriği Platformu işletmek, güvenceye almak, iyileştirmek ve açıklamak için gerekli olduğu ölçüde barındırma, saklama, çoğaltma, görüntüleme, dağıtma, işleme, analiz etme, moderasyon yapma ve tanıtma hakkı veren münhasır olmayan, dünya çapında, telifsiz bir lisans verirsiniz.

Kullanıcı İçeriğinizi göndermek ve işlemek için gerekli hak ve izinlere sahip olduğunuzu beyan edersiniz. Yetkili olmadığınız ve riski değerlendirmediğiniz sürece gizli, regüle, hukuka aykırı, zararlı, ihlal oluşturan veya üçüncü taraf kişisel verilerini yüklememeli ya da göndermemelisiniz.

Herkese açık içerik; özellik ayarlarına ve uygulanabilir lisanslara bağlı olarak diğer kullanıcılar tarafından indekslenebilir, kopyalanabilir, tartışılabilir, çatallanabilir, incelenebilir veya yeniden kullanılabilir. Gizli kalmasını beklediğiniz içeriği yayımlamayınız.
...
İhlaller; içerik kaldırma, oran sınırlama, askıya alma, sonlandırma, hukuki işlem veya hukuken gerekli ya da izinli hallerde yetkili makamlara bildirim sonucunu doğurabilir.

---

## 7. Açık Kaynak, Katkılar ve Markalar

LenserFight; depo katkı kuralları, lisans, davranış kuralları ve güvenlik politikası kapsamında açık kaynak katkıları memnuniyetle karşılar. Depoya gönderilen katkıların, aksi açıkça kararlaştırılmadıkça projenin kullandığı lisans şartları altında sunulduğu kabul edilir.

Depo lisansı, kodun kendi şartları kapsamında kullanılmasına izin verir. Ancak projenizi resmi LenserFight hizmeti gibi göstermeye, LenserFight adlarını veya marka varlıklarını karıştırıcı biçimde kullanmaya, yazılı izin olmadan onay ima etmeye, barındırılan Platform politikalarını aşmaya veya barındırılan altyapıyı kötüye kullanmaya izin vermez.
...
## 9. Hizmet Değişiklikleri, Erişilebilirlik, Ücretler ve Yedekler

LenserFight, Platformun herhangi bir bölümünü istediği zaman güncelleyebilir, değiştirebilir, askıya alabilir, kaldırabilir, kısıtlayabilir veya sonlandırabilir. Kullanıcıları, altyapıyı, bakımcıları veya topluluğu korumak için oran sınırları, özellik bayrakları, moderasyon kapıları, acil durdurma anahtarları, onay kapıları veya erişim kısıtları uygulanabilir.

Platform herhangi bir SLA, erişilebilirlik taahhüdü, yedekleme garantisi, veri geri yükleme garantisi veya performans taahhüdü olmadan sunulur. İhtiyaç duyduğunuz verilerin yedeklerini tutmaktan ve self-hosted dağıtımları üretim kullanımı öncesinde doğrulamaktan siz sorumlusunuz.

Ücretli barındırılmış özellikler, sponsorluklar, abonelikler, kullanım kredileri, model kredileri veya ticari planlar sunulursa ilgili ödeme ekranı, fatura, ödeme sağlayıcısı, iade ve plana özgü şartlar da uygulanabilir. Krediler veya kullanım hakları nakit, parasal değer, elektronik para, mevduat, hediye kartı, menkul kıymet veya finansal araç değildir.
...
## 11. Tazmin Yükümlülüğü

Kullanıcı İçeriğiniz, Platformu kötüye kullanımınız, bu Şartları ihlaliniz, üçüncü taraf haklarını ihlaliniz, hukuka aykırı veri işlemeniz veya agent, iş akışı, araç, konektör ya da self-hosted dağıtımları güvensiz işletmeniz nedeniyle doğan talepler, zararlar, kayıplar, sorumluluklar, masraflar ve giderler bakımından, hukukun izin verdiği ölçüde LenserFight'ı tazmin etmeyi ve zarardan ari tutmayı kabul edersiniz.
