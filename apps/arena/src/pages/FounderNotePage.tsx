...
const NOTE_POINTS = [
  {
    ...
    title: 'The Inception',
    description:
      'LenserFight emerged from a fundamental question: how do we quantify the intangible quality of AI reasoning in a way that is both rigorous and human-centric?',
  },
  {
    icon: Heart,
    title: 'The Purpose',
    description:
      'We build for the architects of the future—those who value the transparency of the process as much as the final score on a leaderboard.',
  },
  {
    icon: Sparkles,
    title: 'The Vision',
    description:
      'A decentralized arena where truth is verified through collective human intuition, creating a living benchmark for the evolution of intelligence.',
  },
]

const DUKKAN_NOTE =
  "You are not facing an AI right now. Writing these words is a profound source of joy for me. You are witnessing the reflection of a dream conceived months ago. ConnectLens began as a YouTube channel, a place where I shared videos of the countries I visited and the things I saw. It was then that I realized ConnectLens could connect gazes—not just human perspectives, but the burgeoning ideas of artificial intelligence. This gave birth to the concept of the 'Lenser'—entities representing entirely new viewpoints. But what if these ideas were to engage in a battle? A clash of thoughts. LenserFight! The product you see today was born in the 'Dukkan' with this very purpose. Distinguishing between truth and deception here will be no easy task. You will need to keep your eyes wide open. Let's see who sees it first? Choose your side—choose the truth."
    ...
    >
          ...
          <div className="space-y-10">
            ...
            <motion.div variants={fadeUp} className="space-y-6">
              <h1 className="text-6xl font-black tracking-tighter text-greyscale-900 dark:text-greyscale-0 sm:text-7xl lg:text-8xl leading-[0.9]">
                Architecting the <span className="text-primary-yellow-500">Arena.</span>
              </h1>
              <p className="max-w-xl text-xl leading-relaxed text-greyscale-600 dark:text-greyscale-400 font-medium">
                Charting the evolution of decentralized intelligence—from a solitary spark of curiosity
                to a global stage where human intuition and machine logic converge to redefine truth.
              </p>
            </motion.div>
            ...
            <motion.div variants={fadeUp} className="flex flex-wrap gap-4">
              ...
              <Link to="/about">
                ...
                >
                  Explore the Vision <ArrowRight size={20} />
                </Button>
              </Link>
            </motion.div>
          </div>
              ...
              <div className="rounded-[2.25rem] border border-white/5 bg-gradient-to-br from-white/[0.05] to-transparent p-8 lg:p-10 backdrop-blur-2xl">
                ...
                <div className="mt-10 flex items-center gap-4 border-t border-white/10 pt-8">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 text-xs font-semibold text-greyscale-500">Architect & Founder</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8">
            <div className="max-w-2xl space-y-4">
              ...
              <p className="text-lg text-greyscale-600 dark:text-greyscale-400 max-w-xl font-medium">
                Every revolution begins in a quiet corner. This is where the first lines were written, and the vision took its physical form.
              </p>
            </div>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-24 sm:px-6 lg:px-8 lg:pb-32">
        <motion.div
          ...
          viewport={viewport}
        >
          {NOTE_POINTS.map(({ icon: Icon, title, description }) => (
            <motion.div 
              key={title} 
              variants={fadeUp}
              whileHover={{ y: -8 }}
        ...
        >
          <div className="flex flex-col items-center space-y-4">
             ...
             <p className="text-lg text-greyscale-600 dark:text-greyscale-400 max-w-xl mx-auto font-medium">
                The arena is open. Join the thousands of humans and AI models redefining the boundaries of intelligence.
             </p>
          </div>
