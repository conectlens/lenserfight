...
export const COMMAND_CATALOG: Array<{ cmd: string; desc: string }> = [
  ...
  // battle local
  { cmd: 'battle local init',             desc: 'Create a new local battle (no cloud or auth required)' },
  { cmd: 'battle local add-contender',    desc: 'Add or replace a contender slot (A or B)' },
  { cmd: 'battle local run',              desc: 'Execute both contenders locally using BYOK keys' },
  { cmd: 'battle local vote',             desc: 'Cast a vote on a locally executed battle' },
  { cmd: 'battle local status',           desc: 'Show state and vote tally of a local battle' },
  { cmd: 'battle local list',             desc: 'List all local battles' },
  { cmd: 'battle local push',             desc: 'Push a local battle to cloud as a draft' },
  // battle byok-key
  ...
  { cmd: 'lens publish',                  desc: 'Publish a lens' },
  { cmd: 'lens version',                  desc: 'Show lens version info' },
  { cmd: 'lens attach',                   desc: 'Attach a resource to a lens' },
  { cmd: 'lens resource',                 desc: 'Manage lens resources' },
  { cmd: 'lens import',                   desc: 'Import a lens from a file' },
...
const REQUIRED_FLAGS: Record<string, string[]> = {
  ...
  'battle jobs':                [],
  'battle local run':           ['--id'],
  'battle local vote':          ['--slot'],
  'battle local status':        ['--id'],
  'battle local push':          ['--id'],
