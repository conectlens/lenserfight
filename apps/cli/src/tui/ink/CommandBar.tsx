...
/**
 * The `:` command bar with live autocomplete. Purely presentational — key
 * handling lives in the parent Dashboard's useInput. Suggestions come from
 * the command inventory (`buildCommandInventory()`, see ../dashboard.ts),
 * not a hardcoded catalog — every real command is reachable, and new
 * commands show up here automatically.
 */
