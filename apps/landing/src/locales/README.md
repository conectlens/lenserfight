...
Modular, namespace-based translation files for `apps/landing`.
...
2. Add imports to `apps/landing/src/i18n.ts`
3. Add namespace name to `LANDING_NAMESPACES` array
...
3. Add imports to `apps/landing/src/i18n.ts`
