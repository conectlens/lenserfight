...
export function ArenaPulseSection() {
  ...
  return (
    ...
    >
      ...
      {/* Live grid — Battles widgets deliberately excluded here; Battles are
          still experimental/planned, see the Roadmap. */}
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {/* Hot threads */}
        <ArenaHotThreadsWidget 
          baseUrl={RUN_APP_URL} 
          title={t('home:pulse.hotThreads.title')}
          emptyTitle={t('home:pulse.hotThreads.emptyTitle')}
          emptyDescription={t('home:pulse.hotThreads.emptyDescription')}
        />

        {/* Trending lenses */}
        <ArenaTrendingLensesWidget 
          baseUrl={RUN_APP_URL} 
          title={t('home:pulse.trendingLenses.title')}
          emptyTitle={t('home:pulse.trendingLenses.emptyTitle')}
          emptyDescription={t('home:pulse.trendingLenses.emptyDescription')}
        />
      </div>
