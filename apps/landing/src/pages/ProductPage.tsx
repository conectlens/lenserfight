        ...
        >
          ...
          <div className="space-y-6">
            ...
            <motion.div variants={fadeUp} className="flex flex-wrap gap-3">
              <a href={`${RUN_APP_URL}/lenses/create`}>
                <Button variant="primary" size="lg">
                  {t('common:cta.createFirstLens')} <ArrowRight size={16} />
                </Button>
              </a>
              <a href={`${RUN_APP_URL}/workflows/create`}>
                <Button variant="secondary" size="lg">
                  {t('common:cta.createFirstWorkflow')}
                </Button>
              </a>
            </motion.div>
          </div>
          ...
          <motion.div variants={fadeUp}>
            <Card className="h-full space-y-4 p-8">
              ...
              <div className="flex flex-wrap gap-3">
                <a href={`${RUN_APP_URL}/workflows`}>
                  <Button variant="dark" size="md">
                    {t('common:cta.exploreWorkflows')}
                  </Button>
                </a>
