...
import { ArrowRight, BookOpen, Sparkles, Waypoints, Bot, CheckCircle2 } from 'lucide-react'
...
const STEPS = [
  ...
  { icon: Sparkles, step: '02', href: '/lenses', external: false },
  { icon: Waypoints, step: '03', href: '/workflows', external: false },
  { icon: Bot, step: '04', href: '/agents', external: false },
] as const
        ...
        <div className="grid gap-10 lg:grid-cols-[0.96fr_1.04fr] lg:items-start">
          ...
          <div className="space-y-4">
            ...
            {STEPS.map(({ icon: Icon, step, href: defaultHref, external: defaultExternal }, index) => {
              const isBuildStep = index === 1 && audience === 'build'
