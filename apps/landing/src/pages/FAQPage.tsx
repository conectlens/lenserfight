...
const FAQ_GROUPS: FaqGroup[] = [
  {
    id: 'trust',
    entries: [
      { id: 'whatIsThis', icon: HelpCircle },
      { id: 'whoIsItFor', icon: Users },
      { id: 'isItReady', icon: Compass },
      { id: 'whyExperimentalLabels', icon: ShieldCheck },
      { id: 'roadmap', icon: Map },
    ],
  },
  {
    ...
    entries: [
      ...
      { id: 'whatIsWorkflow', icon: Workflow },
        ...
        >
          <Card className="grid gap-6 p-8 lg:grid-cols-[1fr_auto] lg:items-center">
            ...
            <div className="flex flex-col flex-wrap gap-3 sm:flex-row lg:flex-shrink-0 lg:flex-col">
              <a href={`${RUN_APP_URL}/lenses?utm_source=lenserfight&utm_medium=arena_faq&utm_campaign=arena_faq_cta`}>
                <Button variant="primary" size="lg" fullWidth>
                  {t('common:cta.exploreLenses')} <ArrowRight size={16} />
                </Button>
              </a>
              <Link to="/roadmap">
                <Button variant="secondary" size="lg" fullWidth>
                  {t('common:cta.viewRoadmap')} <Map size={16} />
                </Button>
              </Link>
