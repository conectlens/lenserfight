  ...
  return (
    <div className="relative overflow-hidden bg-surface-base">
      ...
      <section className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        ...
        {/* Real result page screenshot — not a simulation */}
        <motion.div
          className="mb-12"
        ...
        >
          ...
          >
            <img
              src="/screenshots/battle-detail-light.png"
              alt={t('battleShowcase:preview.showcaseDemoTitle')}
              className="w-full dark:hidden"
              loading="lazy"
            />
            <img
              src="/screenshots/battle-detail-dark.png"
              alt={t('battleShowcase:preview.showcaseDemoTitle')}
        ...
        >
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-3">
            <a
              href={`${WEB_APP_URL}/battles/create`}
