/**
 * i18n configuration for apps/landing.
 *
 ...
 *
 * @see apps/landing/src/locales/README.md for namespace map and contribution guide.
 */
...
i18n
  ...
  .init({
    ...
    ns: LANDING_NAMESPACES as unknown as string[],
    defaultNS: 'common',
