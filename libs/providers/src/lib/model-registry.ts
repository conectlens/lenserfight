...
const MODEL_ENTRIES: ModelRegistryEntry[] = [
  // ── OpenAI text ──────────────────────────────────────────────────────────
  // gpt-5.4, gpt-5.4-mini, gpt-5.4-nano are real OpenAI GA models (June 2026).
  // gpt-5.4-pro and gpt-5.2 are LF-only keys; they alias to the closest tier.
  // gpt-4o / gpt-4o-mini remain self-referencing for backward compat (still
  // accepted by OpenAI but superseded by the gpt-5.x series).
  ...
  // ── OpenAI image ─────────────────────────────────────────────────────────
  // gpt-image-1 is deprecated; gpt-image-2 is the current state-of-the-art.
  // dall-e-4 is the LF forward key; gpt-image-1 kept as a redirect for callers
  // that already have the old name in stored lens versions.
  ...
  // claude-sonnet-4 and claude-opus-4 (dated 20250514) are deprecated and
  // retire June 15 2026; claude-sonnet-4-0 / claude-opus-4 keys kept as
  // redirect aliases until then.
  ...
  // ── Google text (Gemini) ─────────────────────────────────────────────────
  // gemini-3.1-pro-preview and gemini-3-flash-preview are real API model IDs
  // (current previews). gemini-3-pro-preview is deprecated by Google; its LF
  // key stays as a redirect to gemini-2.5-pro. gemini-3.1-flash-lite-preview
  // is also deprecated by Google; redirect to the stable gemini-3.1-flash-lite.
  ...
  // is the latest preview. veo-2.0-generate-001 remains listed as stable/legacy.
  ...
  // ── Mistral ──────────────────────────────────────────────────────────────
  // magistral-medium-2509 / magistral-small-2509 are deprecated; replaced by
  // mistral-medium-3.5 and mistral-small-4 respectively.
