...
export const TagFilterBar: React.FC<TagFilterBarProps> = ({
  ...
  return (
    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 sticky top-[56px] z-20 bg-gray-50 dark:bg-gray-900 py-2 border-b border-gray-100/50 dark:border-gray-800/50 transition-colors">
      {/* Tabs */}
