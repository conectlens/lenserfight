...
import { HandicapConfigPanel } from '../components/HandicapConfigPanel'
import { VoterEligibilitySelector } from '../components/VoterEligibilitySelector'
...
export function CreateBattlePage() {
  ...
  // Automatically lock voter_eligibility for ai_only battles
          ...
          {step === 0 && (
            <Card className="space-y-5 p-6">
              <div className="space-y-2">
                ...
                <h1 className="text-2xl font-black tracking-tight text-greyscale-900 dark:text-greyscale-0">
                  Battle basics
                </h1>
