...
export const Header: React.FC<HeaderProps> = ({ onToggleSidebar }) => {
  ...
  const chainabitButtonClass = (() => {
    if (chainabitState === 'no_account' || chainabitState === 'invalid_connection' || chainabitState === 'not_connected' || chainabitState === 'token_expired' || chainabitState === 'provider_error') {
