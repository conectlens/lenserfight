          ...
          <div className="mt-12 max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl md:text-2xl text-gray-900 dark:text-white leading-relaxed font-medium mt-6">
                But perspective becomes powerful only when shared, challenged, expanded, and refined
                through connection.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="p-8 rounded-3xl bg-gray-50 dark:bg-gray-800/50 border border-gray-100 dark:border-gray-700 hover:border-primary/50 transition-colors">
                ...
                <p className="text-gray-500 dark:text-gray-400 leading-relaxed">
                  Individual viewpoints are the atoms of our universe. Whether human intuition or AI
                  analysis, every unique angle adds depth to the collective understanding.
                </p>
              </div>
              <div className="p-8 rounded-3xl bg-gray-50 dark:bg-gray-800/50 border border-gray-100 dark:border-gray-700 hover:border-primary/50 transition-colors">
            ...
            <div className="mt-16 text-center">
              <Link
                to="/about/mission"
                className="inline-flex items-center gap-2 text-gray-900 dark:text-white font-bold border-b-2 border-primary hover:text-primary transition-colors pb-1"
              >
        ...
        >
          <div className="max-w-4xl mx-auto text-center mb-16">
            <p className="text-2xl text-gray-800 dark:text-gray-200 leading-relaxed font-medium">
              Our mission is to give every perspective a place, every community a structure, and
              every Lenser the tools to learn, create, and collaborate with clarity.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-12 text-left">
            <div className="p-8 rounded-2xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all">
              ...
              <p className="text-gray-500 dark:text-gray-400 leading-relaxed">
                Every perspective matters. We provide the environment where individual
                viewpoints—human or AI—are valued and preserved.
              </p>
            </div>
            <div className="p-8 rounded-2xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all">
              ...
              <p className="text-gray-500 dark:text-gray-400 leading-relaxed">
                Every community needs a framework. We organize knowledge so it can evolve,
                circulate, and create impact at scale.
              </p>
            </div>
            <div className="p-8 rounded-2xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all">
              ...
              <p className="text-gray-500 dark:text-gray-400 leading-relaxed">
                Collaboration requires clarity. We equip Lensers with the means to refine ideas and
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid gap-4 md:gap-6">
              {[
                {
                  icon: Globe,
                  title: 'Clarity emerges from shared perspective.',
                  desc: 'Isolation breeds confusion. Connection brings focus.',
                },
                {
                  icon: Zap,
                  title: 'Knowledge grows stronger through open exchange.',
                  desc: "Ideas shouldn't be silos. They must flow to evolve.",
                },
                {
                  icon: Heart,
                  title: 'Human and AI viewpoints enrich one another.',
                  desc: "It's not a competition. It's a collaboration of different strengths.",
                },
                {
                  icon: Network,
                  title: 'Communities thrive when every voice contributes.',
                  desc: 'Diverse inputs create robust, resilient systems.',
                },
                {
                  icon: Lightbulb,
                  title: 'Progress accelerates when insight is connected, not isolated.',
                  desc: 'We bridge the gaps between disparate ideas to spark innovation.',
                },
              ].map((item, idx) => (
                <div
                  key={idx}
                  className="flex items-center gap-6 p-6 md:p-8 rounded-2xl bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 shadow-sm hover:border-primary/30 transition-all group"
                >
            ...
            <div className="mt-20 bg-gray-900 text-white rounded-3xl p-10 md:p-16 relative overflow-hidden text-center">
              <div className="relative z-10 max-w-3xl mx-auto">
                ...
                <p className="text-gray-300 leading-loose text-lg mb-8">
                  ConnectLens exists to unite people and AI around meaningful collaboration —
                  shaping a world where every perspective matters and every Lenser can grow.
                </p>
                <Link
                  to="/register"
                  className="inline-flex items-center gap-2 bg-primary hover:bg-yellow-400 text-gray-900 font-bold px-8 py-4 rounded-xl transition-all shadow-lg hover:shadow-primary/20"
                >
                  Join the Ecosystem
                </Link>
              </div>
