...
import { PromptParam, PromptParamType } from '@lenserfight/types'

interface ParameterPanelProps {
  params: PromptParam[]
  onChange: (params: PromptParam[]) => void
}

const PARAM_TYPES: { value: PromptParamType; label: string }[] = [
...
function updateParam(params: PromptParam[], index: number, patch: Partial<PromptParam>): PromptParam[] {
        ...
        {params.map((param, i) => (
          ...
          >
            ...
            <div>
              <SelectField
                value={param.type}
                onChange={(val) => onChange(updateParam(params, i, { type: val as PromptParamType, options: undefined, arrayFormat: undefined }))}
                options={PARAM_TYPES}
                className="w-full"
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              {param.type === 'array' && (
                <SelectField
                  ...
                  onChange={(val) => onChange(updateParam(params, i, { arrayFormat: val as PromptParam['arrayFormat'] }))}
