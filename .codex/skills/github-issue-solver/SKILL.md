...
2. Run smallest relevant test set first:
...
3. If no adequate tests exist for the fixed behavior, add them.
...
5. Run broader checks for critical areas:
...
Only after all CI checks pass and no unsafe migrations or security regressions exist:
